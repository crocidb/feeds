...
description = "When evaluating Pollen I complained about markdown/pandoc’s lack of sidenote handling. I have solved it for Pollen but felt it deserved it’s own post.A caveat: I generated Tufte CSS style"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2019/03/04/pollen_sidenotes/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.446442397Z"
seen = true
---

When evaluating Pollen [I complained](/blog/2019/03/03/first_impressions_of_pollen/) about markdown/pandoc’s lack of sidenote handling. I have solved it for Pollen but felt it deserved it’s own post.

A caveat: I generated [Tufte CSS](https://edwardtufte.github.io/tufte-css/) style sidenotes and marginnotes which made it more complex than if I had simply generated “standard” sidenotes. If you want to adapt this yourself I’m sure you can simplify the code to fit your needs.
...
By having the sidenote span right in the middle of the text it allows us to [toggle it without javascript](https://stackoverflow.com/questions/11023816/toggle-divs-without-using-javascript). This appeals to me as a heavy noscript user but it has a significant drawback: you cannot have block level tags like `div` or `p` inside a `span`.
