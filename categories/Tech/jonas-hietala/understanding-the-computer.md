...
description = "When I discovered programming it felt like a whole new world opened up for me with endless possibilities. It granted unlimited power and I could create virtually anything and it explained so much to me - how did a program work? How could you make a game or a website? But there wa"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2012/12/15/understanding_the_computer_bottom_up/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.699810871Z"
seen = true
---
...
After that we had a construction course, we could make a digital *thing*! Maybe a processor, hurr? [So we did](https://github.com/treeman/MARC/). We made a microprogrammed processor, simulated on an FPGA, which ran redcode. I even wrote an assembler for it!
...
We had a super fun course about operating systems and we did some work in [pintos](http://www.stanford.edu/class/cs140/projects/pintos/pintos_1.html), an OS where you’re supposed to improve and implement parts of it. It was perhaps the best course I’ve had yet and I learnt a *ton*. Threading, scheduling, system calls, security, file systems, launching programs, etc…
...
There are still things I’d like to do more of. More games, more assembly code, more hardware controlling stuff, using my [newly gotten](/blog/2012/12/14/early_christmas_present/) [raspberry pi](http://www.raspberrypi.org/) perhaps?, and I definately want to make my own programming language sometime.