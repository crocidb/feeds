...
description = "  The end goal, as rendered by Autodesk’s online viewerI’m not sure where it came from, but it was suddenly very important that I got myself a 3D printer. Maybe it was an important insight, but it maybe it was only a fix idea I got that somehow bec"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2023/10/13/lets_build_a_voron_build_start/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.317059526Z"
seen = true
---

 ![](/images/trident/trident.png) The end goal, as rendered by Autodesk’s online viewer
...
Either way, I now have lots of parts for a [VORON Trident 250](https://vorondesign.com/voron_trident) and I figured I’ll try to document the journey of building it (or failing to).
...
1. An [Ender 3](https://www.creality.com/products/ender-3-3d-printer) seems like a cheap and popular printer, maybe that’s a good place to start?
2. Hmm, the quality of an [Ender 3](https://www.creality.com/products/ender-3-3d-printer) doesn’t seem that great and the internet says that you’ll spend a lot of time to tweak and modify it until you get something good.
3. The [Prusa MK4](https://www.prusa3d.com/en/product/original-prusa-mk4-2/) has just released, and their printers have historically been really solid.
...
6. Damn, this [VORON](https://vorondesign.com/) thing looks amazing and at around the same price range of the Prusa.

And that’s how I ended up wanting a [VORON](https://vorondesign.com/).

Now, a [VORON](https://vorondesign.com/) is a really cool printer and there are lots of things that drew me towards it:
...
At this point it didn’t matter that I’m a complete 3D printer noob and that a [VORON](https://vorondesign.com/) is not recommended for beginners. I wanted one, and settling for something else would just leave me filled with regrets and I would’ve just bought a [VORON](https://vorondesign.com/) later anyway. So I bought the printer I wanted directly instead.
...
Now as I said a [VORON](https://vorondesign.com/) isn’t a beginner printer, but I did take some countermeasures to hopefully make the build more manageable for me:
...
1. Even though the kit comes with the Klicky Mod, I want to use [VORON Tap](https://github.com/VoronDesign/Voron-Tap) because I got this idea that Tap would be better.

   At the moment I’m not planning to install Klicky at all, but we’ll see how that goes.

As I don’t have a printer I used the [print it forward](https://pif.voron.dev/) service to buy the printed parts for the printer.

What I got
==========

![](/images/trident/boxes.jpg) I’ve got a bunch of boxes

These are the items I’ve ordered:

* LDO VORON Trident 250
* Phaetus Rapido Plus Hotend UHF
* [VORON Tap hardware kit](https://github.com/VoronDesign/Voron-Tap)
* Printed parts

I first ordered a kit from [caribou3d.com](https://caribou3d.com/en/) but after waiting months without progress I canceled it and ordered from [3djake.com](https://www.3djake.com/) instead (where I bought the Rapido).
...
[There is a helpful video](https://www.youtube.com/watch?v=hpkN9NHoKiY), but I’m still very worried that I’ve placed one of them wrong or missed some, and I have to disassemble the frame at a later stage.

![](/images/trident/build_1.jpg) Assembling the frame. I really, really hope that I’ve placed the t-nuts correctly.

Heatset inserts
==========

What to do with the heatset inserts? The LDO kit comes with a [heatset insert tool](https://docs.ldomotors.com/guides/heatset_insert_tool_guide)… But it didn’t fit the soldering iron I had. What to do?

Turns out you don’t need it, and you can just use the soldering iron with a regular tip:

![](/images/trident/heatset_insert.jpg)
...
![](/images/trident/build_2.jpg) The frame is built and I’ve added three of the rails.
