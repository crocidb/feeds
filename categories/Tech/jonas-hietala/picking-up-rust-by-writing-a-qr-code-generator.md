...
description = "I wanted to pick up rust again after having used it many years ago. After around 5 years or so I didn’t really know where to start?Approaches to picking up a languageWhen learning, or as in this case re-learning, a programming language ther"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2019/04/17/picking_up_rust_by_writing_a_qr_code_generator/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.434795462Z"
seen = true
---

I wanted to pick up [rust](https://www.rust-lang.org/) again after having used it many years ago. After around 5 years or so I didn’t really know where to start?
...
I’ve read a lot of programming books and in general it’s a very good tool to learn new things. For rust you could for example read [The Rust Programmaing Language](https://doc.rust-lang.org/stable/book/title-page.html), which is a pretty good introduction.

During my university time I did a little competitive programming, so you’d think I’d love the idea of solving programming puzzles. For example via [Advent of Code](https://www.forrestthewoods.com/blog/learning-rust-via-advent-of-code/), [Project Euler](https://projecteuler.net/) or doing [katas](https://github.com/gamontal/awesome-katas). But truth be told—I’m not that into such puzzles. I prefer making “real” projects that does something useful for me.
...
Following a tutorial, like the excellent [writing an OS in Rust](https://os.phil-opp.com/), can be amazingly useful. Both for learning a language but mostly for learning about a specific domain—like learning about operating systems.
...
By chance I found a thorough [QR code tutorial](https://www.thonky.com/qr-code-tutorial/) and it got me thinking, is it a good starter project?
...
Seems pretty good! So [I made one](https://github.com/treeman/rqr).
...
The [documentation](https://docs.rs/rqr) and overall code quality should be fairly good but as this was just a learning project I don’t plan on extending it with new features.