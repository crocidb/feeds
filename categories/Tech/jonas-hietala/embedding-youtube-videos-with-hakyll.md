...
description = "A while ago a made a timelapse of my entry to Ludum Dare. This is how I parse and embed videos using Hakyll.I don’t want to remember any special syntax for embedding, I don’t want to bother (remember?) to use something like {% youtube: <link%} o"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2014/09/01/embedding_youtube_videos_with_hakyll/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.610257098Z"
seen = true
---

A while ago a made a timelapse of my entry to Ludum Dare. This is how I parse and embed videos using [Hakyll](http://jaspervdj.be/hakyll/).
...
The styling of the video is [from another blog post](http://webdesignerwall.com/tutorials/css-elastic-videos):
...
[https://www.youtube.com/watch?v=NIbr-mLi4DU](https://www.youtube.com/watch?v=NIbr-mLi4DU)

The full source can be found [on github](https://github.com/treeman/jonashietala).