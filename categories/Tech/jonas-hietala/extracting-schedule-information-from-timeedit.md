...
description = "At LIU we use timeedit to track our schedules. Recently they updated their interface and improved some parts. It’s now possible to create a prenumeration of a collection of courses exported as csv which can then be imported to other calendar apps. But they also started to obfus"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2014/11/27/extracting_schedule_information_from_timeedit/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.596689384Z"
seen = true
---
...
[https://se.timeedit.net/web/liu/db1/schema/ri157XQQ519Z50Qv27045gZ6y7Y7206Q6Y45Y7.html](https://se.timeedit.net/web/liu/db1/schema/ri157XQQ519Z50Qv27045gZ6y7Y7206Q6Y45Y7.html)

This is for the courses `TGTU49` and `TATA49` in the same interval:

[https://se.timeedit.net/web/liu/db1/schema/ri15YXQ2519Z55Qv2X0457Q6y4Y120876Y45Y7gQ6076775Z7.html](https://se.timeedit.net/web/liu/db1/schema/ri15YXQ2519Z55Qv2X0457Q6y4Y120876Y45Y7gQ6076775Z7.html)
...
[https://se.timeedit.net/web/liu/db1/schema/ri1Q7.html](https://se.timeedit.net/web/liu/db1/schema/ri1Q7.html)

We find a GET request to

[https://se.timeedit.net/web/liu/db1/schema/objects.html?max=15&fr=t&partajax=t&im=f&sid=3&l=sv&search\_text=TGTU49&types=219&fe=132.0&fe=115.20132,20141,20142](https://se.timeedit.net/web/liu/db1/schema/objects.html?max=15&fr=t&partajax=t&im=f&sid=3&l=sv&search_text=TGTU49&types=219&fe=132.0&fe=115.20132,20141,20142)
...
Which seems to suggest that we can send a request directly to [https://se.timeedit.net/web/liu/db1/schema/ri.html](https://se.timeedit.net/web/liu/db1/schema/ri.html) with url parameters.

For example

[https://se.timeedit.net/web/liu/db1/schema/ri.html?sid=3&p=140703-141231&objects=363972.219](https://se.timeedit.net/web/liu/db1/schema/ri.html?sid=3&p=140703-141231&objects=363972.219)

Is a search for `TGTU49` (data-id: 363972.219) between 2014-07-03 and 2014-12-31 and

[https://se.timeedit.net/web/liu/db1/schema/ri.html?sid=3&p=140703-141231&objects=363972.219%2C363741.219](https://se.timeedit.net/web/liu/db1/schema/ri.html?sid=3&p=140703-141231&objects=363972.219,363741.219)
...
We can also get information formatted as `.txt` and `.csv`. For parsing purposes the best one should be json, as we can use rust’s [json deriving](http://doc.rust-lang.org/serialize/json/), but then we need to create a bunch of structs. `.csv` is actually very easy to parse and it looks like this:
...
I made a [rust crate](https://github.com/treeman/libtimeedit) which uses the outlined approach to retrieve scheduling information from timeedit. There’s a bunch of things I’m not supporting, but it’s enough for my needs. I made a simple [cli](https://github.com/treeman/liuschema) and integrated a `.schema` command into my [irc bot](https://github.com/treeman/rustbot).