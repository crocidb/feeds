...
description = "For some reason I’ve done a couple of personality tests the last month, mostly to satisfy my own curiosity.The Braverman TestInspired by Charles Poliquin’s visit on The Tim Ferriss Show I tried out the [Braverm"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2016/12/11/tests/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.497438484Z"
seen = true
---
...
Inspired by [Charles Poliquin’s visit on The Tim Ferriss Show](http://fourhourworkweek.com/2015/07/21/charles-poliquin/) I tried out the [Braverman test](http://advancedpsychcare.tripod.com/sitebuildercontent/sitebuilderfiles/braverman.test.pdf) to determine my neurotransmitter type. The point Charles makes is that the type of training most suited to you is determined by your neurotransmitter type, which can be found using the Braverman test.
...
I couldn’t find any good references to what the ranges mean but I think it means I have a balanced dominant nature and slight GABA and Serotonin deficiencies. According to [this article](http://www.theinertia.com/surf/the-five-elements-of-athlete-its-all-about-neurotransmitters/) I’m an Earth type:
...
What [Charles says](https://www.t-nation.com/training/five-elements) about Earth types also rhymes well. Especially the part about cold and sleep:
...
I tried to fill out [a test](http://adhd-npf.com/wp-content/uploads/2009/01/18Q-ADHDTest.pdf) (Swedish) and reading about ADHD online. It seems everything fits really well, for example:
...
For fun I tried out an [aspergers test](http://aspergerstest.net/aq-test/) and I scored a 28. According to the site that means:
