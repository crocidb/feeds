...
description = "mdBook is a tool for easily creating books out of Markdown files. It's very popular in the Rust ecosystem, where it's used (among other things) to publish the official Rust book.mdBook has a simpl"
date = "2025-12-18T02:11:00Z"
