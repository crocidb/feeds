...
description = " It’s astonishing how much time it takes to support things that are already working. E.g. every upgrade of Doom Emacs (which I love to use but hate to tinker with) is about several things at once:1. Upgrade itself e.g. doom upgrade"
date = "2022-10-11T11:33:00Z"
url = "https://vlnn.dev/2022-10-11-maintainance-of-configurations-before-it-comes-to-renovation.html"
...
[Tags](https://vlnn.dev/tags.html): [emacs](https://vlnn.dev/tag-emacs.html) [macbook](https://vlnn.dev/tag-macbook.html) [chores](https://vlnn.dev/tag-chores.html) [howto](https://vlnn.dev/tag-howto.html)