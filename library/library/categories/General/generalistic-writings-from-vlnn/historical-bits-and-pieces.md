...
description = " Some time ago I was a part of a team who introduced modern software development processes (text-based sources, CI, CD, cloud here and there) across the company with humongous and very cleverly written monolith. Yup, internally sources were not stored as text files. Yup, the form"
date = "2022-10-12T18:43:00Z"
url = "https://vlnn.dev/2022-10-12-historical-bits-and-pieces.html"
...
![things-i-did.jpeg](./static/things-i-did.jpeg)
...
[Tags](https://vlnn.dev/tags.html): [apl](https://vlnn.dev/tag-apl.html) [git](https://vlnn.dev/tag-git.html) [legacy](https://vlnn.dev/tag-legacy.html)