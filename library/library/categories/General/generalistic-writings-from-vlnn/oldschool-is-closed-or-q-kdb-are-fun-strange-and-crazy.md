...
description = "https://lv1.sh/ is another layer of crazyness that seems to be normal for k/q language for decades. Also beware, this link was removed on lobste.rsK is an array-based language by Arthur Whitney, who worked toge"
date = "2026-07-30T00:00:00Z"
url = "https://vlnn.dev/?stack=oldschool-is-closed"
...
Don't forget about the [Incunabulum](https://www.jsoftware.com/ioj/iojATW.htm). Don't forget that [jsoftware](jsoftware.com) was not that different and provided closed-sourced binaries for around 15 years before becoming relatively sane. It was pretty OK for the industry; `we are different from them now, and they are not that crazy`. Or maybe they are and we will become a bit later.

Q: Is `k` having a standard? A: God no