...
description = " I’ve bought a daylight lamp and not sure about it. The idea beside this product is that if human being has less daylight than usual due to bad weather or wrong lifestyle, they may use artificial light source with the spectrum of emission that is similar to natural sunlight. More"
date = "2022-10-12T12:07:00Z"
url = "https://vlnn.dev/2022-10-12-daylight-lamp:-first-day.html"
...
![daylight-lamp.gif](static/daylight-lamp.gif)
...
[Tags](https://vlnn.dev/tags.html): [light](https://vlnn.dev/tag-light.html) [lamp](https://vlnn.dev/tag-lamp.html) [health](https://vlnn.dev/tag-health.html)