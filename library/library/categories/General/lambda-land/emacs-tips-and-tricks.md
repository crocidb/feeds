...
description = "To Learn About ☒ Company-mode (completion framework for lots of stuff) ☒ YASnippets (templates) ☒ Auto-YASnippets (something like that—I installed it for temporary templates) ☒ Alchemist mode (integrates with company mode—tooling for Elixir)* ☐ What do M-. and `M-"
date = "2017-09-23T00:00:00Z"
url = "https://lambdaland.org/posts/2017-09-23-emacs-tips-and-tricks/"
author = """
          ...
          """
text = ""
lastupdated = "2026-07-21T09:22:07.348371651Z"
seen = false
+++
...
* `C-x r b` Jump to a bookmark. Mnemonic: “*b*ookmark”, or “*b*ack to *b*ookmark”
...
* `C-x C-k C-c` Prompts for the initial value of the keyboard macro. Must be called prior to starting macro definition to be used this way. It has another behavior if called during macro definition. See [this page](https://www.emacswiki.org/emacs/EmacsKeyboardMacroCounter) for help.
