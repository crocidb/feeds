+++
title = "DuckDuckGo"
description = "DuckDuckGo is a search engine. Like Google Search, you just throw some keywords into a box and get a list of results. Lots of people use Google, but I don’t. DuckDuckGo works better for me, and this is why.Consistent ResultsDid you know that Google will give you differe"
date = "2019-01-15T00:00:00Z"
url = "https://lambdaland.org/posts/2019-01-15-duckduckgo/"
author = """
...
Did you know that Google will give you different search results, based on who you are and what you have searched for in the past? This is called a [filter bubble](https://en.wikipedia.org/wiki/Filter_bubble), and it’s [annoying and dangerous](https://spreadprivacy.com/google-filter-bubble-study/). DuckDuckGo doesn’t put you in a filter bubble.
...
For a full list of instant answers, see [here](https://duck.co/ia).

For a full list of Bang-directives, see [here](https://duckduckgo.com/bang).
