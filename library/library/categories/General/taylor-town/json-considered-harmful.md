+++
title = "JSON Considered Harmful"
description = """So you want to powerful systems to talk to each other over a network with limited capacity and unreliable connections?Let's try to build the worst "universal" notation possible:1. Ensure that the common notation that all the systems speak is extremely low-level, so that you have """
date = "2018-09-15T00:00:00Z"
url = "https://taylor.town/json-considered-harmful"
author = "Taylor Troesh"
text = ""
lastupdated = "2026-04-20T13:20:40.789895680Z"
seen = true
+++
