...
description = "One thing I always have wished that my reMarkable 2 had was web browser. It wouldn't need to be very efficient nor the best browser out there. Just something simple I can use to read definitions for words or other small knowledge when I'm reading articles I've sent to the device."
date = "2025-08-31T00:03:12Z"
url = "https://akselmo.dev/posts/netsurf-on-remarkable-2/"
author = "Akseli"
text = ""
lastupdated = "2026-05-27T23:22:57.012072592Z"
seen = true
+++
...
[SSH connection and passcode](#ssh-connection-and-passcode)
----------
...
[Install XOVI + extensions and apploader](#install-xovi-extensions-and-apploader)
----------
...
[Install Netsurf](#install-netsurf)
----------
...
### [Resources and fonts](#resources-and-fonts) ###
...
Note: the `/opt/share/fonts/ttf-dejavu/` folder may get deleted when the device updates. You could also move the TTF files into `/home/root/ttf-dejavu` to avoid that from happening, but you will have to modify the `/home/root/.netsurf/Choices` files accordingly.
...
* If you have text rendering issues, set the value `scale:100` in the `Choices` file.
  * This can cause very small font size, so set the `font_size:180` and `font_min_size:180` values too.
