+++
title = "Reading Time Estimates for Pandoc Based Blog Generators"
description = "If you, like me, are one of those who have written their own static-site generators based on Pandoc using Haskell, or use a framework made on top of it<sup1</sup, this post provides a little code snippet to compute the reading time estimate for your blog posts. You can "
date = "2025-05-13T00:00:00Z"
url = "https://abhinavsarkar.net/notes/2025-pandoc-reading-time/"
...
This post was originally published on [abhinavsarkar.net](https://abhinavsarkar.net/notes/2025-pandoc-reading-time/?mtm_campaign=feed).
...
1. Like [Hakyll](https://jaspervdj.be/hakyll/), [Slick](https://github.com/ChrisPenner/slick) or [Ema](https://ema.srid.ca/).[↩︎](#fnref1)

2. I cross-checked the estimates with those provided by the [Miniflux](https://miniflux.app/) feed reader, and they are quite close.[↩︎](#fnref2)
...
* [Fediverse](https://fantastic.earth/@abnv/114501531258312548)
* [My website](https://abhinavsarkar.net/notes/2025-pandoc-reading-time/?mtm_campaign=feed#comment-container)
