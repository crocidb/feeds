...
description = "Last month I posted about my journey migrating my site server from an old Ubuntu server to FreeBSD. Some people on Hacker News noticed that, when I showed the fastfetch result, I sa"
date = "2026-07-02T00:00:00Z"
url = "https://crocidb.com/post/freebsd-ate-my-ram/"
author = "Bruno Croci"
text = ""
lastupdated = "2026-07-03T16:48:49.257709191Z"
seen = true
+++
...
![top reports each section of memory, swap and disk cache with a lot of details](images/Pastedimage20260701210436.png)
...
![82% of used memory!](images/Pastedimage20260701214745.png)
...
![Only 7% used?!](images/Pastedimage20260701214704.png)
...
![4.49G/5.69G](images/Pastedimage20260701215158.png)
...
![My next tattoo right there!](images/Pastedimage20260701222127.png)
...
![I installed FreeBSD over 10 times this last month, I think I might be able to follow the installer with my eyes closed](images/Pastedimage20260618221424.png)
...
![I tried different filesystems to check if I was missing something on non-ZFS systems](images/Pastedimage20260618233614.png)
...
![vfs.bufspace reports FreeBSD’s own filesystem metadata buffer cache, which is bypassed by ARC](images/Pastedimage20260702171641.png)
...
![FreeBSD, Linux, SunOS (?) and NetBSD now can detect ARC cache](images/Pastedimage20260702174142.png)
...
![That’s impressive 400 pages of the source-code alone, plus a CD-ROM!](images/Pastedimage20260703001620.png)
