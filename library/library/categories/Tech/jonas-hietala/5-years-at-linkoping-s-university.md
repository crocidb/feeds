...
description = "I recently finished my master’s degree (civilingenjör or civil engineering) at Linköping’s University. At first it felt like 5 years would be an eternity, but in hindsight it was over in a flash. my gut feeling is that I haven’t learnt or done anything of note, except you know ac"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2015/07/22/5_years_at_the_university/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.574868615Z"
seen = true
---
...
The digital circuit labs were followed by a digital project of our own choice. We [designed a processor](https://github.com/treeman/MARC) which could run the [Core Wars 88 standard](http://corewar.co.uk/icws88.txt) and we simulated it on an FPGA.

![](/images/marc_schema.png) The main block schema for the processor

And here is a small video of the simulation in action:

[https://www.youtube.com/watch?v=E2sehbjNtDg](https://www.youtube.com/watch?v=E2sehbjNtDg)

The project was interesting as it was an outlet for our creativity and it touched on several different areas. Processor design, hardware debugging (!) and I wrote a [redcode assembler](https://github.com/treeman/MARC/blob/master/scripts/assembler) for our CPU and a [microcode compiler](https://github.com/treeman/MARC/blob/master/scripts/control_codes).
...
For example [the microcode](https://github.com/treeman/MARC/blob/master/scripts/microcode) is described in our DSL:
...
And is then compiled into [VHDL code](https://github.com/treeman/MARC/blob/master/src/MARC/microcontroller.vhd):
...
If you’re interested in the project you can [read more on github](https://github.com/treeman/MARC).
...
This year me and a friend also made game in the Java programming course called [Grand Thief Arto](/blog/2011/10/19/grand_thief_arto/). Not the greatest of games but it was still fun to make it. I also became a mentor in discrete math for the first year students which was a fun and easy way to earn a bit of extra money.
...
A much better project was the [Robot project](/blog/2013/01/20/i_robot/) where we created an autonomous robot! There we poked around with hardware and lower level programming in C.

![](/images/trap14/Robot_0018.JPG) Debugging this was quite an experience

I continued to be a mentor in discrete math and I joined [Team Obelix](http://obelix.cyd.liu.se/) which organized student visits to different companies. I won the “best CV” award given by Ericsson, I won some things in the local programming competition [IMPA](https://www.ida.liu.se/projects/impa/new/results) and I had a great course in operative systems where we used [Pintos](http://web.stanford.edu/class/cs140/projects/pintos/pintos.html). I took an extra course in Graph Theory which was quite different from other math courses but very interesting. Additionally I took a [Programming Languages](https://www.coursera.org/course/proglang) course at Coursera, also quite nice.

This summer I also had my first real programming job which was a summer internship at [Configura](http://www.configura.com/) and I had a really good time and we replaced their triangulation software.

Fourth year
==========

The courses from the previous years were all mandatory, with the exception of some extra courses I took, but for the 4th and 5th year I could choose my own profile and what courses to take. I spent quite a lot of time thinking about which courses I wanted to take. In the end I’m quite happy with my selection but there are many interesting courses I had to say no to. The main profile I targeted was the [Programming and Algorithms](https://www.ida.liu.se/edu/ugrad/program/profiler/pal/index.sv.shtml) profile.
...
7. TDDA69 Data and Program Structures ([SICP](https://mitpress.mit.edu/sicp/full-text/book/book.html))

I didn’t find the compiler course *as* fun as I had initially thought. The theory part wasn’t very interesting but the lab part was really, really good! All in all it still was a very fun course. The AI courses (Automated Planning and Artificial Intelligence) were great and AI is an area I’m very interested in. During this time I also took an [online course in Machine Learning](https://www.coursera.org/learn/machine-learning) via Coursera by Stanford University. Number Theory is another maybe niche area in mathematics which I found interesting.

I continued doing some programming competitions as can be seen in [UVa](http://uhunt.felix-halim.net/id/115705) which enabled my to go to [NWERC 2013](http://2013.nwerc.eu/) in the Netherlands. Ultimately I’m not super good at these competitions but it was still a great experience. Netherlands (or specifically Delft) was great. In the Multicore and GPU Computing course there was a parallel sorting contest which I and my lab partner managed to win. The goal was to create a sorting routine on the CPU with the best sorting performance. Oh and I also went through the classic book Structure and Interpretation of Computer Programs or [SICP](https://mitpress.mit.edu/sicp/full-text/book/book.html) in a course. Very excellent book!

During the summer I also took part in [IDA Summer of Code 2014](/blog/2014/10/06/ida_summer_of_code_2014_summary/) where I contributed to [rust](https://github.com/rust-lang/rust). I also had my [second summer job at Configura](/blog/2014/07/13/summer_job_at_configura/):

![](/images/configura14/octree2.png) Our octree implementation
...
In the end I think I managed to get rid of the worst effects of the burnout and I managed to finish my studies. I was also a mentor in discrete math for a fourth time. I didn’t complete a ton of courses as the whole last semester was spent on writing my [Master’s thesis](/masters_thesis/) but I did complete a great course in cryptology and one about logic programming in Prolog.

The cryptology course was especially good as it even introduced [Bitcoin](https://bitcoin.org/en/) and the way the blockchain worked. Big kudos to that! I was aware of Bitcoin before but I wasn’t aware of the implementation details.
