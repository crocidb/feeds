...
description = "As I added a /now page to the site I also decided to refresh my /about page and I figured it would be neat to have timeline element where I could list some of the larger events in my life.To my surprise it wasn’t too difficult to create one that looks pretty cle"
date = "2025-01-18T19:09:35Z"
url = "http://jonashietala.se/blog/2024/08/25/a_simple_timeline_using_css_flexbox/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.174171859Z"
seen = true
---

As I added a [/now](/now) page to the site I also decided to refresh my [/about](/about) page and I figured it would be neat to have timeline element where I could list some of the larger events in my life.
...
### [Events to the left](#Events-to-the-left) ###
...
### [Events to the right](#Events-to-the-right) ###
