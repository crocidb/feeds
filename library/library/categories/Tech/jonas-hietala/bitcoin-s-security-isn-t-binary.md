...
description = "I’d like to address a misconception that’s at the core in many Bitcoin discussions lately: Bitcoin’s security isn’t binary. In fact security in general isn’t black and white. It’s a trade-off being secure enough for your threat model vs the cost and feasibility of your protection"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2018/07/28/bitcoins_security_isnt_binary/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.467186712Z"
seen = true
---
...
[A double spend attack was used in the wild to reverse transactions 22 blocks deep in Bitcoin Gold in May](https://www.trustnodes.com/2018/05/24/bitcoin-gold-51-attacked-18-million-stolen-double-spends). Bitcoin isn’t as easily attacked since there’s not enough mining power mining other coins that can simply be temporarily rerouted for the attack but it demonstrates the attack nicely.
...
If you want to learn more I heartily recommend [the whitepaper](https://bitcoin.com/bitcoin.pdf) which is quite easy to read.
...
* [Double-spending Prevention for Bitcoin zero-confirmation transactions](<http://users.encs.concordia.ca/~clark/biblio/bitcoin/Karame 2015.pdf>)
...
But it’s theoretically possible and thus businesses like exchanges and payment processors would still want full nodes for the extra security. [Satoshi agrees](https://bitcoin.com/bitcoin.pdf):
...
Despite SPV wallets being quite secure running a full node is presented as a requirement for everyone. Core developer Luke-Jr [doesn’t even consider SPV wallet users “actual users”](https://www.reddit.com/r/Bitcoin/comments/5ant54/questions_about_running_a_full_node/d9i1zyt/):
...
I bring you the case of SegWit, a solution to the [transaction malleability problem](https://en.bitcoin.it/wiki/Transaction_malleability). Jaqen Hash’ghar wrote a [great article (2016)](https://medium.com/the-publius-letters/segregated-witness-a-fork-too-far-87d6e57a4179) of the whole ordeal. I recommend it although it’s a bit long.
...
[https://www.youtube.com/watch?v=VoFb3mcxluY](https://www.youtube.com/watch?v=VoFb3mcxluY)
