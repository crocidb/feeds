...
description = "The eBook for my book Why Cryptocurrencies? is now available for free.It’s been almost 4 years since the [web version](https://whycryptocu"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2024/02/19/the_ebook_for_why_cryptocurrencies_is_now_available_for_free/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.256947059Z"
seen = true
---

The eBook for my book [Why Cryptocurrencies?](https://whycryptocurrencies.com/) is now [available for free](https://buy.whycryptocurrencies.com/download).

It’s [been almost 4 years](/blog/2020/04/29/my_book_why_cryptocurrencies_is_done/) since the [web version](https://whycryptocurrencies.com/toc.html) was done, and [3 since the physical copy was available](/blog/2021/05/31/why_cryptocurrencies_is_now_available_in_print/)… Which can hardly be called a success.

Things happened, so let’s do a quick retrospective to, maybe, learn something.

[The project is done](#The-project-is-done)
----------
...
[I made it more difficult for myself than it had to be](#I-made-it-more-difficult-for-myself-than-it-had-to-be)
----------
...
1. I used a [non-standard generator](/blog/2020/05/03/how_i_wrote_my_book_using_pollen/), with no native eBook or PDF generation support.
...
3. I wanted to take payments in crypto, so before I made the eBook I made my own [cryptocurrency payment processor](https://github.com/bitpal/bitpal).
...
[Burnout, procrastination, and losing faith](#Burnout-procrastination-and-losing-faith)
----------
...
I wrote a [separate post about my burnout](/blog/2023/03/14/battling_burnout/), no need to rehash the details of that unpleasant experience again here. With the burnout (and the depression that tagged along), my heavy procrastination, and the arrival of two kids, maybe the surprising thing isn’t that it took so long, but that I got anything done at all?

### [Procrastination is about doing the wrong thing](#Procrastination-is-about-doing-the-wrong-thing) ###
...
For example, instead of finishing the book project I [rewrote the blog in Rust](/blog/2022/08/29/rewriting_my_blog_in_rust_for_fun_and_profit/), refactored it to [use Djot instead of Markdown](/blog/2024/02/02/blogging_in_djot_instead_of_markdown/) (despite Markdown working just fine), [built a 3D printer](/series/voron_trident/), and spent tons of time [designing my own keyboard layout](/series/t-34/)…
...
### [I still believe in the potential of crypto….](#I-still-believe-in-the-potential-of-crypto) ###

I still firmly believe that cryptocurrencies has an amazing unrealized potential—and I still stand behind the majority of my arguments [in the book](https://whycryptocurrencies.com/), where I focus on what cryptocurrencies can be useful for. In many ways I think the arguments of digital cash are even stronger today than when I started writing the book some 5 years ago.
...
![](/images/lasereyes-min.jpg) The LaserEyes Bitcoin campaign exemplifies everything I loath about crypto.
...
How’s that for a recommendation for [my book](https://whycryptocurrencies.com/) that extols the virtues of crypto? :)
