...
description = "I recently bought the Eight Sleep Pod 4—a smart mattress cover that tracks your heart rate, HRV, snoring, and cools or warms the mattress during the night. There’s a lot to like about the mattress but in the end I opted to retur"
date = "2025-05-16T18:14:03Z"
url = "http://jonashietala.se/blog/2024/10/05/trying_and_returning_the_eight_sleep_pod_4/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.161391430Z"
seen = true
---

I recently bought the [Eight Sleep Pod 4](https://www.eightsleep.com/se/product/pod-cover/)—a smart mattress cover that tracks your heart rate, HRV, snoring, and cools or warms the mattress during the night. There’s a lot to like about the mattress but in the end I opted to return it.

This post describes my experience with the Pod 4.

[Sleep is important enough to offset the steep price](#Sleep-is-important-enough-to-offset-the-steep-price)
----------

The [Eight Sleep](https://www.eightsleep.com/se/) mattress is really expensive but that’s not all—it’s a mattress with **a subscription**! I hated it when [Oura](https://ouraring.com/) introduced a subscription for their ring, and I hate the world that led us to a *mattress* with a subscription.
...
[My experience with the smart mattress](#My-experience-with-the-smart-mattress)
----------
...
* There’s no way to connect it to Home Assistant.
  ...
  An integration for Home Assistant [actually exists](https://github.com/lukas-clarke/eight_sleep). I feel very silly now.
...
[Using the free 30 day return](#Using-the-free-30-day-return)
----------
