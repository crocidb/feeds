...
description = "My first commit on my book Why Cryptocurrencies? is from Dec 19, 2018, and now about 17 months later and 1006 more commits I’m finally done!Well, I’m done with the online version at least. I still plan to create an e-book, a PDF and a paperback"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2020/04/29/my_book_why_cryptocurrencies_is_done/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.416016706Z"
seen = true
---

My first commit on my book [Why Cryptocurrencies?](https://whycryptocurrencies.com/) is from Dec 19, 2018, and now about 17 months later and 1006 more commits I’m finally done!
...
Anyhow it’s [available online for free](https://whycryptocurrencies.com/) and I’m actually quite proud of what I’ve accomplished. It doesn’t really matter if it’s not successful and if I won’t get financially rewarded for the time I’ve spent, because I did my best and I think it came out nicely.

![](/images/whycrypto/ex_money.png) A screenshot of the chapter “What is money?”
...
As I wrote my book in [Pollen](https://docs.racket-lang.org/pollen/), which mixes text with markup and source code, it’s not so easy to get a reliable word count. When counting the output html files with `sed "s/<[^>]*>//g" eli5.html | wc -c ` I come up with these numbers:
