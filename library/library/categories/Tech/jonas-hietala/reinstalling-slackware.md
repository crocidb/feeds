...
description = "So I reinstalled slackware on my machine and decided to take some rough notes of the most important steps I made. I did not document the steps in detail, and some are very specific for my setup. But maybe it can be useful for someone, or myself.Basic steps"
date = "2025-01-18T19:11:55Z"
url = "http://jonashietala.se/blog/2014/07/05/reinstalling_slackware/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.638154273Z"
seen = true
---
...
### [Make slackware usb loader](#Make-slackware-usb-loader) ###
...
Be sure `/dev/sdX` is the usb, dd will wipe everything! Simple way is to `ls /dev` before and after plugging in device. Boot from bios (f2 or f10).

### [Make partitions](#Make-partitions) ###

Make partitions [http://slackbook.org/html/installation-partitioning.html](http://slackbook.org/html/installation-partitioning.html)
...
### [Install wicd, get online](#Install-wicd-get-online) ###
...
Fetch latest stable kernel source: [https://www.kernel.org/](https://www.kernel.org/)
...
From [http://www.linuxquestions.org/questions/slackware-14/how-to-optimize-fonts-in-slackware-640468/page29.html#post5067546](http://www.linuxquestions.org/questions/slackware-14/how-to-optimize-fonts-in-slackware-640468/page29.html#post5067546), [http://blog.lysender.com/2013/11/optimizing-fonts-for-slackware-14-1-without-infinality/](http://blog.lysender.com/2013/11/optimizing-fonts-for-slackware-14-1-without-infinality/)

Enable subpixel rendering from source slackbuild [http://ftp.slackware.com/pub/slackware/slackware-14.1/source/l/freetype/](http://ftp.slackware.com/pub/slackware/slackware-14.1/source/l/freetype/). Edit freetype.Slackbuild
...
Enable subpixel rendering. Test [http://www.lagom.nl/lcd-test/subpixel.php](http://www.lagom.nl/lcd-test/subpixel.php), choose rgb, gbr, or whatever. Also useful: [https://wiki.archlinux.org/index.php/Font\_configuration](https://wiki.archlinux.org/index.php/Font_configuration)
...
[Random Installs](#Random-Installs)
----------

### [Slackbuilds](#Slackbuilds) ###

Download from [http://slackbuilds.org/](http://slackbuilds.org/). Install with `installpkg`. Remove with `removepkg`.
...
[http://alien.slackbook.org/dokuwiki/doku.php?id=slackware:multilib](http://alien.slackbook.org/dokuwiki/doku.php?id=slackware:multilib) Also add blacklist.

When installing 32bit run `. /etc/profile.d/32dev.sh`

### [Better latex](#Better-latex) ###
...
Get `OpenAL` from slackbuilds. Get Java JDK [http://docs.slackware.com/howtos:software:java](http://docs.slackware.com/howtos:software:java), not OpenJDK.
