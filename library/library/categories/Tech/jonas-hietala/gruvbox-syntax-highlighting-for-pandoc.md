...
description = "Edit: I have updated the highlighting again so the inline code used as examples have changed. I guess I should’ve used images to record the look.Recently when I [reinstalled Slackware](/blog/2015/08/02/slackw"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2015/08/04/gruvbox_syntax_highlighting_for_pandoc/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.563846096Z"
seen = true
---

**Edit:** I have [updated the highlighting](/blog/2019/01/25/site_restyle_and_update#changes-to-code-display) again so the inline code used as examples have changed. I guess I should’ve used images to record the look.

Recently when I [reinstalled Slackware](/blog/2015/08/02/slackware_update) I decided to restyle my workspace as well. I settled on [gruvbox](https://github.com/morhetz/gruvbox) with neovim and using [the generalized](https://github.com/morhetz/gruvbox-generalized) package I also styled my terminal.
...
This works with the [highlighting-kate package](http://hackage.haskell.org/package/highlighting-kate) which is what [pandoc](http://pandoc.org/index.html), and therefore [Hakyll](http://jaspervdj.be/hakyll/), is using.
...
Currently I’m happy with the result and you can view the source of this site at [https://github.com/treeman/jonashietala](https://github.com/treeman/jonashietala).