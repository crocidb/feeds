...
description = 'I think rust is one of the most interesting upcoming programming languages out there. So I wrote a solution to the 8-puzzle (see the 15-puzzle) using A\*. It also has a breadth first search for solutions on a '
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2014/01/21/8-puzzle_in_rust/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.668993002Z"
seen = true
---

I think [rust](http://www.rust-lang.org/) is one of the most interesting upcoming programming languages out there. So I wrote a solution to the 8-puzzle (see the [15-puzzle](http://en.wikipedia.org/wiki/15_puzzle)) using A\*. It also has a breadth first search for solutions on a specific distance away from the goal.
