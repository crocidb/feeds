...
description = 'Deutsche Übersetzung folgt.I’ve left\ Facebook.There’s an asterisk there. I’m not going to delete my account, but I’m no longer checking Facebook more than once or twice a month, if that. I’m not trying to be a recluse—below are a few ways to contact me that I do* check far m'
date = "2018-06-23T00:00:00Z"
url = "https://lambdaland.org/posts/2018-06-23-leaving-facebook/"
author = """
          ...
          """
text = ""
lastupdated = "2026-07-21T09:22:07.341591309Z"
seen = false
+++
...
* Email—*my first name* dot *then my last name* at mailblock dot net.<sup class="footnote-reference" id="fr-1-1"><a href="#fn-1">1</a></sup> That’s probably the easiest.
...
* Email—*mein erster Name* Punkt *mein letzter Name* at mailblock Punkt net.<sup class="footnote-reference" id="fr-2-1"><a href="#fn-2">2</a></sup> Das ist wahrscheinlich am einfachsten.
...
1. I’m not writing that in normal form because I don’t want a web scraper to find it and spam me. Yuck. I like it when search engines find my blog posts. I don’t like it when they find my email address. [↩](#fr-1-1)

2. Ich hab mein Emailaddresse so geschrieben, damit ich kein Spam bekommen werde. Ich mag es, wenn das Internet mein Post sieht. Ich mag es nicht, wenn schlechte Programmen mein Emailaddresse finden. [↩](#fr-2-1)