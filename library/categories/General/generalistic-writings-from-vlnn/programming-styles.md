...
description = "Writing code and reading code are both depend on notation — notation becoming a tool of thought. E.g. it's so much easier to solve system of differential equations using APL than assembler, that assembler p"
date = "2026-09-12T00:00:00Z"
url = "https://vlnn.dev/?stack=programming-styles"
...
In Rebol either requires quite some effort to re-implement all the transducers library:
