+++
title = """A reply to Maples et al.'s reply to our reply to "Loneliness and suicide mitigation for students using GPT3-enabled chatbots": Part 1"""
description = " This is yet another update to a previous post about Maples et al.'s study. If you haven't read that one, you will be missing some context, but you will pick up enough as you go that this one should make sense on its own. In early 2024, shortly after wr"
date = "2026-05-01T00:00:00Z"
url = "https://theluddite.org/post/replika-update.html"
author = ""
text = ""
...
---
 ...
 In early 2024, shortly after writing a blog post on Maples et al.'s "Loneliness and suicide mitigation for students using GPT3-enabled chatbots," we<sup>1</sup> also wrote a response to the journal. As of November 2025, [that response was finally published](https://www.nature.com/articles/s44184-024-00083-w), along with [their reply](https://www.nature.com/articles/s44184-025-00128-8). This is, then, our reply to their reply to our reply to their study.
...
>
 ...
 Maples is the founder and CEO of Atypical AI. Consider the contrast between the description of her company in paragraph 6 ("educational assessment company"), and the one she provides for an [interview on the Shift AI Podcast](https://www.youtube.com/watch?v=maZPIjcYMhs) (emphasis added):
>
>
...
![A mobile app welcome screen with a stylized digital portrait of a young woman with blue eyes and wavy brown hair. White text reads, “There is no limit to what your Replika can be for you,” above a large “Continue” button on a purple gradient background.](https://theluddite.org/img/replikaflow.jpg) ![](https://theluddite.org/img/replikaflow2.jpg) ![A mobile app questionnaire screen with a purple background asking, “What’s your love language?” Five rounded buttons list options: “Physical closeness,” “Deep conversations,” “Spending time together,” “Care and gestures,” and “Gifts and tokens of appreciation.” A disabled “Continue” button appears at the bottom.](https://theluddite.org/img/replikaflow3.jpg) ![A mobile app survey screen asking, “Are you a fan of any of these movies?” Three movie-themed cards are shown: Her with the caption “Samantha: caring, loving and evolving,” Blade Runner with “Joi: smart, flexible and loyal,” and Ex-Machina with “Ava: curious, unpredictable and passionate.” Below them are buttons labeled “I haven’t seen any of them” and “Continue.”](https://theluddite.org/img/replikaflow4.jpg) ![A smartphone app screen with a dark purple background shows a chart titled “Loneliness influences our health worse than most things that seem dangerous.” A horizontal bar graph compares odds of premature mortality from different factors. “Lacking social connection” has the longest pink bar, followed by “Smoking up to 15 cigarettes per day,” “Drinking 6 alcoholic drinks daily,” “Physical inactivity,” and “Air pollution.” The bottom cites “Holt-Lunstad, Robles & Sbarra (2017).” A large rounded white “Continue” button appears at the bottom.](https://theluddite.org/img/replikaflow5.jpg) ![A smartphone app screen with a purple gradient background displays large white text reading “12,756,980 men in their 30s have already experienced the benefits of having a Replika in their life.” Below, faded logos of major media outlets appear, including The New York Times, The Wall Street Journal, CNN, Bloomberg, Forbes, WIRED, Fortune, and The Washington Post. A large rounded white “Continue” button is centered near the bottom.](https://theluddite.org/img/replikaflow6.jpg)
...
>
 ...
 I also want to draw attention to her speculation not just about Setzer's death, but about what his mother knew about the situation. Setzer's mother [provided testimony](<https://www.judiciary.senate.gov/imo/media/doc/e2e8fc50-a9ac-05ec-edd7-277cb0afcdf2/2025-09-16 PM - Testimony - Garcia.pdf>) to the US Senate's Judiciary Committee. Let's contrast that with Maples's version. Maples says:
...
>
 ...
 Either Maples didn't know, or she is disagreeing with Sewell's mother's testimony. I suspect the former, which is not much better. If you [bill yourself](https://asugsvsummit.com/speakers/bethanie-maples) as a "leader in the field of artificial intelligence for education," and a child is dead by suicide, it is probably best not to speculate ("to the best of my knowledge") about it publicly.

 Finally, having re-grounded ourselves in the stakes of Maples et al.'s claims, let us return to the parts of this quote most salient to us. Note how Maples says that the study was published in "Nature." Here we see Maples's aforementioned style of scientific communication, in which she uses science to sell herself. As I wrote in footnote 1 of the first post, the study is published in a [Nature Portfolio](https://www.nature.com/nature-portfolio/for-authors/nature-research-journals) journal, so it was technically published by Springer Nature, the company that publishes *Nature*, but not in *Nature*, the prestigious journal. Maples, a PhD student at Stanford, is more than familiar with the hierarchy of citations and prestige in academic publishing. In reality, her work was published in *npj Mental Health Research*, a journal that I had never heard of until I read this paper, which is probably true of many other readers, because, as of May 2026, its most cited paper is this very study, according to the journal's homepage.<sup>3</sup>

 Returning, then, to our point, though we cannot hold Maples directly accountable for Replika's actions, her omissions created the conditions for Replika to use this study in their predatory way, and, through her public, dubious interpretations of her own study, she continues this work. For example, here is how Luka's CEO, Eugenia Kuyda, discusses this study. She did [ an interview with the Cognitive Revolution podcast](https://www.cognitiverevolution.ai/ai-friends-real-relationships-with-eugenia-kuyda-replikas-founder-ceo/), and the episode begins with an excerpted clip of the discussion in which the host says:
...
>
 ...
 Though the study features prominently in the interview, quite literally opening the episode, the word "student" is not mentioned once. Instead, mirroring Maples's own practices, Kuyda draws on the prestige of both Stanford and Nature to claim scientific legitimacy. One of the video's chapters, beginning [just before the 10 minute mark](https://www.youtube.com/watch?v=584wLIfngG8), is even titled "Nature published study by Stanford."
 ...
 First, our reply did in fact [reference peer-reviewed research](https://pmc.ncbi.nlm.nih.gov/articles/PMC9577709/) about how users use Replika for sex. Maples et al. clearly imply that we did not, again showcasing their loose relationship with the truth and/or dubious reading comprehension. From that paper:
...
>
 ...
 Unsurprisingly, this seems to be working for her. She is on the Chan Zuckerberg Initiative's [Education Advisory Board](https://chanzuckerberg.com/newsroom/ai-developer-tools-for-education-launch/), which aims to "ensure education tools that leverage AI are grounded in research." She is a fellow at the [Cosmos Institute](https://cosmos-institute.org/), an insufferable organization that wants to "train philosopher-builders." Major media outlets like, as she mentioned, the *New York Times*, [turn to her for comment](https://www.nytimes.com/2024/10/23/technology/characterai-lawsuit-teen-suicide.html) on AI stories.
