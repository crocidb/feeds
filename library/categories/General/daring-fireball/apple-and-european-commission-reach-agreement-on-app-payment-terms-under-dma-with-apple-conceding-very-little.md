+++
title = "★ Apple and European Commission Reach Agreement on App Payment Terms Under DMA, With Apple Conceding Very Little"
description = "Thanks to the DMA’s sprawling scope, complexity, and overreach, Apple came out of this conceding only 4 percent of the App Store’s 30 percent commission, and no reduction at all to the 15 percent for subscriptions after the first year."
date = "2026-08-20T15:12:16Z"
url = "https://daringfireball.net/2026/08/apple_eu_business_terms_conceding_little"
author = "John Gruber"
text = ""
...
All apps have to pay at least the 5 percent Core Technology Commission, even if they’re distributed outside the App Store. I could collect a lot of claim chowder from people who told me that Apple’s CTC was never going to pass muster. Maybe it wouldn’t have under the old EC regime of the [crusading hypocrite Margrethe Vestager](<https://daringfireball.net/2024/03/more_on_the_eus_market_might#:~:text=Margrethe Vestager herself>) and the [buffoonish Thierry Breton](https://daringfireball.net/linked/2024/09/16/breton-resigns), but the European Commission is under [new](https://daringfireball.net/linked/2026/05/12/teresa-ribera-visited-the-us-and-no-one-noticed), [more temperate leadership](https://daringfireball.net/linked/2026/05/12/new-dma-compliance-features-for-eu-users-in-ios-265).

Ben Thompson, [in a subscriber-only Stratechery update](https://stratechery.com/2026/apple-settles-with-e-u-u-s-app-store-fees-att-rules-in-germany/), works out the implied values from these fees:
...
Don’t take my word that this agreement is a sweeping victory for Apple — with the company conceding only the reduction from 30 to 26 percent for App Store payments — and a capitulation by the EC. [Here’s Epic Games, posting on Twitter/X](https://x.com/EpicNewsroom/status/2089787577062559951):
...
I don’t think Epic understands that [the Commission *has* accepted these terms](https://www.independent.ie/business/apple-will-change-its-app-store-rules-to-end-its-dispute-with-the-eu/a/160196535.html), and they’re a result of negotiations. It’s over.
