+++
title = "★ Thoughts and Observations on Apple’s ‘Surprise and Shine’ Event; the Announcements of the iPhones 18 Pro, AirPods 5, Apple Watches Series 12 and Ultra 4, and the iPhone Duo; and the Dawn of the Ternus, John Ternus Era at Apple"
description = "The keynote, the products, and a new era."
date = "2026-09-15T17:54:09Z"
url = "https://daringfireball.net/2026/09/thoughts_and_observations_on_apples_surprise_and_shine_event"
author = "John Gruber"
text = ""
...
I loved [the keynote](https://www.youtube.com/watch?v=39BalPDuTo0)’s “You want a great opening scene?” opening, which ran through a series of genre-inspired hook-you-from-the-first-shot pretend movie openings. Apple started with a title card that said “The following was shot on iPhone”, but the whole keynote — including the fun fake-movie openings — was shot on iPhone 18 Pros. [Apple started shooting](https://www.apple.com/newsroom/2023/10/behind-the-scenes-at-scary-fast-apples-keynote-event-shot-on-iphone/) its keynote movies using iPhone Pros in October 2023, [with the “Scary Fast” Mac event](https://daringfireball.net/linked/2023/10/31/downplaying-shot-on-iphone). That first one was shot on the then-just-released iPhone 15 Pro, the first iPhone Pro generation to support the necessary pro video features to enable Apple-level production quality (e.g. ProRes recording and Apple Log encoding).<sup id="fnr1-2026-09-15"><a href="#fn1-2026-09-15">1</a></sup> For the next few years, Apple shot each of its keynotes using whatever the current iPhone Pro model was. But last year, with [the September 2025 “Awe Dropping” event](https://www.youtube.com/watch?v=H3KnMyojEQU), they shot the keynote using the as-yet-unreleased iPhone 17 Pro itself — a bit of a risk given that it was running mid-summer iOS 26 beta software. They did the same this year, shooting the entire keynote, including the prelude fake movies, using iPhone 18 Pros. But, they couldn’t say that it was the 18 Pro on the title card because the 18 Pro wasn’t announced until later in the keynote.

There was at least [one report](https://www.macrumors.com/2026/09/07/tim-cook-wont-appear-apple-sept-9-event-video/) from an ill-informed know-it-all who claimed, with odd certainty given how often he’s wrong, that Tim Cook would not appear in the keynote. But the last segment of the keynote’s cold opening gave us Cook, Tim Cook, framed in an obvious homage to the opening of 2012’s *Skyfall*:

[<img src="https://daringfireball.net/misc/2026/09/craig.jpeg" alt="Daniel Craig in “Skyfall”." width="400">](https://daringfireball.net/misc/2026/09/craig.jpeg)

[<img src="https://daringfireball.net/misc/2026/09/cook.jpeg" alt="Tim Cook in a “Skyfall” homage at the beginning of the keynote." width="400">](https://daringfireball.net/misc/2026/09/cook.jpeg)

I’ve stolen those comparison frames from [this splendid blog post by Vaziri, Todd Vaziri](https://fxrant.blogspot.com/2026/09/apple-event-film-2018-vs-james-bond.html), in which he points out a few other Bond homages in this keynote — including using the new variable aperture on the 18 Pro’s main camera as a reference to the Bond title-sequence gun barrel. Fun stuff all around, and a perfect way to commemorate the Cook-to-Ternus passing of the torch.<sup id="fnr2-2026-09-15"><a href="#fn2-2026-09-15">2</a></sup> Also, the variety of visual styles in these mini movies really showed off the capabilities of the iPhone 18 Pro as a cinematic camera.

The little Cook / Bond homage that closes the opening segment starts with a voiceover from Cook himself ([starting at 2m:07s](https://www.youtube.com/live/39BalPDuTo0?t=127)):
...
Ternus’s “intelligent personal hub” doctrine seems very much in line with my retort to Levy’s not-entirely-thought-through fantasy. It also sounds an awful lot like a modern-day reimagining of a former Apple CEO’s “digital hub” strategy for the Mac. I highly recommend you take 8 minutes of your time, right now, and watch [Steve Jobs’s introduction of the digital hub strategy](https://www.youtube.com/watch?v=lmvmtmqqbeI) from January 2001’s Macworld Expo. History doesn’t repeat but it does echo, and Ternus’s “intelligent personal hub” sure sounds *exactly* like Jobs’s “digital hub” echoing a quarter century later. If Ternus’s “intelligent personal hub” strategy works out like Jobs’s “digital hub” one did a quarter century ago, Apple’s going to be alright.

iPhone 18 Pro
----------

Heretofore, to my recollection, the iPhone Pro always came last in the September keynotes (including the years when the higher-tier iPhones didn’t yet have the word “Pro” in their names, like the XS in 2018 and X in 2017). This year the 18 Pro came first. This worked both as the immediate product announcement after Ternus’s expression of Apple’s intelligent personal hub strategy, and to clear the final act of the keynote for the much-anticipated Duo. (It’s [somewhat telling](https://daringfireball.net/linked/2026/09/11/last-years-iphone-share-amongst-users-of-widgetsmith) that the Air didn’t get that cleanup spot in the announcement batting order a year ago.<sup id="fnr3-2026-09-15"><a href="#fn3-2026-09-15">3</a></sup>)

Thoughts on the colors, based on my hands-on experience:

* Black: Truly deep black. Reminds me a lot of the flat black iPhone 7 (not to be confused with the jet black iPhone 7 — [what a year for black that was](https://daringfireball.net/2016/09/the_iphones_7)).
...
Compared to [the 17 Pro one year ago](https://www.macrumors.com/2025/09/09/2025-iphone-lineup-storage-and-prices/):<sup id="fnr4-2026-09-15"><a href="#fn4-2026-09-15">4</a></sup>
...
It’s worth pointing out here that coincident with the announcement of the iPhones 18 Pro and Duo on Wednesday, [Apple raised the prices of all existing iPhones in its lineup](https://www.macrumors.com/2026/09/09/apple-raises-iphone-17-prices/) by the same amounts, depending on storage — $100 for models with 128, 256, or 512 GB storage; and $300 for the iPhone Air with 1 TB.

Technically, the iPhone 18 Pro mostly offers three new things compared to the 17 Pro: the A20 Pro SoC (faster cores, two Neural Engines instead of one, and 50% faster memory bandwidth); variable aperture on the 1× main camera, ranging from ƒ/1.48 to ƒ/4.0; and an all-new thermal management system, including a much larger vapor chamber. The A20 Pro means peak performance is faster; the new thermal system allows it to maintain peak performance longer.

In a curious decision, the regular-sized 18 Pro models ship with Apple’s C2 cellular modem worldwide, but the [18 Pro Max models use a Qualcomm modem in the U.S.](https://www.macrumors.com/2026/09/12/iphone-18-pro-max-us-model-difference/), and [the C2 everywhere else](https://x.com/LelloucheNico/status/2098370012570333689). Apple’s C-series modems are power efficiency marvels, with (in my experience) just as good reception and speed. I’d be just ever so slightly bummed about this if I were a Pro Max fan in the US.

That said, both the 18 Pro and Pro Max models continue to get slightly longer battery life [in the US models](https://www.apple.com/iphone-18-pro/specs/) than [worldwide models](https://www.apple.com/uk/iphone-18-pro/specs/), because the US models are eSIM-only, but most (all?) models elsewhere still have a physical SIM tray. The US models use the space occupied by the SIM tray in international models to make the batteries physically larger. Going by Apple’s new “typical use” tech spec, the US Pro / Pro Max models are rated for 24 / 30 hours respectively; the international models with a physical SIM tray for 23 / 29. Not a big difference, but not nothing.
...
* Apple Reference Image is a new shooting mode (main 1× camera only, because it’s tied to new features on that sensor) that performs pixel-by-pixel signing of the sensor data and embeds that signature in the file. After capture, reference images can be sent to Private Cloud Compute servers for verification and comparison to the original image sensor data. To capture images in Apple Reference format, you must shoot them in that mode, and you must enable that shooting mode first. The embedded sensor data doesn’t make files that much larger, but the sensor data stored in the file does uniquely identify your iPhone. When you “develop” a reference image — something the user must choose to do (not something that happens automatically each time you capture one) — the raw sensor data, sensor identifier, and time window when the image was captured are sent to Private Cloud Compute. When you share a photo captured in Apple Reference Image format, the sensor identifier is *not included* in the developed image, and you have the option to share a plain version without the embedded verification data. Apple Reference Image capture is not available in the EU or China, the world’s two largest bastions of freedom, but [according to an Apple footnote](<https://www.apple.com/newsroom/2026/09/apple-debuts-iphone-18-pro-and-iphone-18-pro-max/#:~:text=In the EU>), users in the EU “with iOS 27, iPadOS 27, and macOS 27 will be able to develop and view reference images.”
...
Ternus broke out the hallowed “But actually, there is one more thing...” to introduce the Duo, which line — to circle back to the keynote’s intro — is for Apple CEOs what “Vodka martini, shaken not stirred” is for actors playing James Bond.<sup id="fnr6-2026-09-15"><a href="#fn6-2026-09-15">6</a></sup>
...
At every storage tier, it’s $800 more than an 18 Pro and $700 more than an 18 Pro Max.
...
* The outer glossy screen has a “Center Stage” 12 megapixel front-facing camera, that seems very similar to the 18 megapixel Center Stage front cameras in the iPhone 17 generation phones. Year-ago tech but still high quality. There’s a circular hole punch in the corner of the display for this camera.

* The inner matte screen has an under-the-display “FaceTime” camera for which Apple hasn’t even given a megapixel count. Clearly this is a lesser camera — the question is how much lesser. The idea presumably is that this camera is solely for use in Zoom or FaceTime apps, where you might want to use the bigger inner display to view the meeting, and don’t care as much about your own image quality. But there’s no reason ever to capture a self portrait with the camera on the larger inner display. If the Duo is opened, and you care about image quality for self portraits, you can shoot using the *main* camera and use the small display to frame yourself, turning the large display around to the back. When not using the inner FaceTime camera, there is no visible cutout showing where it goes. If you look closely at the display however, you can see where it is. Under-display cameras aren’t magic.

* The regular cameras are a 1× / 2× main, and a 0.5× ultra wide. I suspect the main 1× camera is very similar optically to that of the iPhone Air, but the Duo has A20 Pro features like Photographic Styles 3, although it lacks Pro Controls, Apple Log, [genlock](https://www.apple.com/newsroom/2025/09/apple-announces-final-cut-camera-2-0/), and other pro camera features. (The Air only has last year’s Photographic Styles 2.)

The initial introduction of the Duo was handled by two keynote newcomers: industrial design VP [Molly Anderson](https://www.apple.com/leadership/molly-anderson/), and human interface VP [Steve Lemay](https://www.apple.com/leadership/steve-lemay/). A hardware / software design duo (*ahem*), if you will. What made it worth having Anderson and Lemay present together is that the iPhone Duo exemplifies Apple’s integrated approach to product design. Are they a hardware company that writes their own software or a software company that makes their own hardware? The answer is yes.<sup id="fnr7-2026-09-15"><a href="#fn7-2026-09-15">7</a></sup> The defining aspect of the Duo isn’t that it folds open and closed — we’ve seen almost a decade of Android phones that do that — but its aspect ratio, roughly 1.4 : 1. Because that’s effectively the square root of 2, doubling the outer display’s shorter dimension when you unfold it produces an inner display with roughly the same aspect ratio. That’s elegant and satisfying conceptually. And I think in practice it will feel right, too.

Heretofore the iPhone has only had three display aspect ratios:

1. The original iPhone (2007) display was precisely 3 : 2 (480⁠ ⁠×⁠ ⁠320 pixels, and let’s call it 1.5 : 1 for comparison’s sake to the following ratios), and this remained true through the iPhone 4 and 4S (960⁠ ⁠×⁠ ⁠640 pixels, 2× retina).
...
* The lack of Face ID is a serious sad-trombone bummer, and in my opinion could sink the first-generation model. Side-button Touch ID is OK, but OK is not *good*, and even good is not *insanely great*. Face ID is insanely great. For whatever reason, the only iPads with Face ID are the iPad Pro models. Every time I review an iPad Air or iPad Mini, my biggest gripe is the lack of Face ID. I complained about it [reviewing the iPad Air in 2022](<https://daringfireball.net/2022/03/the_2022_ipad_air#:~:text=Face ID alone is worth $150>) and [the iPad Mini in 2021](<https://daringfireball.net/2021/09/the_2021_ipad_mini#:~:text=biggest annoyance>), and in the five years since then my annoyance has only grown. With Face ID, so long as you’re looking at the screen as you unlock the device, it’s like not having it locked at all. It just unlocks, seemingly automatically. With Touch ID you must think about putting one of your registered fingers on the button every single time you unlock it. It never ever feels automatic. I feel quite certain Apple tried to fit a Face ID sensor on the outer Duo display and could not make the engineering work.

* I’m much more concerned about convenience than security, but Face ID is 20× more secure than Touch ID. That’s according to Apple’s own [Apple Platform Security](https://help.apple.com/pdf/security/en_GB/apple-platform-security-guide-b.pdf) whitepaper, updated just last month, which states:
...
* As a sign of how inconvenient the lack of Face ID is, Apple is promoting the fact that the iPhone Duo can be unlocked by your Apple Watch, like a Mac. No other iPhone needs such a crutch.<sup id="fnr10-2026-09-15"><a href="#fn10-2026-09-15">10</a></sup> Based on my experience with Touch ID iPads, wearing an Apple Watch all the time to unlock the Duo will feel essential. I don’t wear an Apple Watch all the time, and don’t want to start wearing an Apple Watch all the time, so I suspect this alone will keep me from switching to an iPhone Duo personally. On the other hand, for people who *do* wear an Apple Watch all the time and are happy to do so, the Duo’s lack of Face ID might prove to be only an occasional inconvenience rather than a constant annoyance.<sup id="fnr11-2026-09-15"><a href="#fn11-2026-09-15">11</a></sup>

* [Contrary to some speculation](https://www.macrumors.com/2026/04/24/iphone-ultra-could-be-missing-5-features/), the Duo does support MagSafe. (Samsung’s latest, the Galaxy Z Fold8 and Fold8 Ultra, support inductive Qi charging but don’t have magnets, so you need to use a case or something to get chargers to snap into place.)
...
* Apple rates the Duo as IP68 for dust and water resistance, [with exactly the same description](https://www.apple.com/iphone/compare/?modelList=iphone-duo,iphone-air,iphone-18-pro) as the iPhones 18 Pro (and all other iPhone models currently in the lineup): “Rated IP68 (maximum depth of 6 meters up to 30 minutes) under IEC standard 60529”. Samsung’s new [Z Fold8 is only IP48](https://www.theverge.com/tech/979421/ifixit-samsung-galaxy-z-fold-8-hinge). With these [IEC ratings](https://www.iec.ch/ip-ratings) the second numeral is for water. The first numeral is for “solid foreign agents” (read: dirt and dust). iPhone Duo’s IP6*x* rating means “dust-tight”. The Z Fold8’s IP4*x* rating isn’t even “dust-protected” (that would be IP5*x*) but instead only protection against particles 1mm or larger. 1mm is pretty big for a piece of grit. That doesn’t mean it’s susceptible to ingress from every particle smaller than 1mm, but it’s not good. Pocket lint is a real thing and people put their phones in their pockets.

I’m Trying So Hard Not to Be Insufferable About Predicting the ‘Duo’ Name That I’ve Put This Entire Section 6,500 Words Deep Into the Column
----------

Yours truly, [back on April 14](https://daringfireball.net/linked/2026/04/14/name-of-foldable-iphone):
...
>
>
> But if you want my take on a wildcard name, one with some [history](https://everymac.com/systems/apple/powerbook_duo/index-powerbook-duo.html), how about “iPhone Duo”?
>
>
...
* The early 1990s [PowerBook Duo](https://everymac.com/systems/apple/powerbook_duo/index-powerbook-duo.html) (and [corresponding Duo Dock](https://apple.fandom.com/wiki/Duo_Dock)) were extraordinary Macs that were ahead of their time.
...
When I suggested “Duo” in April and [again the day before the event](https://daringfireball.net/linked/2026/09/07/birchler-folding-iphone-predictions), the number one objection was that Microsoft had used the name “Duo” [for one](https://www.microsoft.com/en-us/d/surface-duo-unlocked/8S3V46W10HFR?activetab=pivot:overviewtab) of its many forgettable Surface products. The half dozen or so readers who argued thus might be the only people alive who remember this product. No one cares. Microsoft [also had a Surface Neo](https://en.wikipedia.org/wiki/Surface_Neo), and no one cares about that one either. Even if Apple hadn’t offered a line of (successful, memorable) PowerBook Duos from 30 years ago, it wouldn’t matter that Microsoft had used “Duo” in 2020. For chrissakes [Cisco had the rights to the name “iPhone” in 2007](https://en.wikipedia.org/wiki/IPhone_(trademark)) and had been making products with the name since 1998.
...
* [Apple’s YouTube video of the entire keynote](https://www.youtube.com/watch?v=39BalPDuTo0) has over 49 million views, and that doesn’t count the views from Apple’s own hosted version, presented on Apple.com and Apple TV. [Apple has](https://www.youtube.com/@Apple/videos) 12 other shorter keynote-related videos on YouTube, including “[Introducing the new iPhone 18 Pro](https://www.youtube.com/watch?v=Q3zwkxqh1t0)” with 18 million views, and “[Introducing the new iPhone Duo](https://www.youtube.com/watch?v=FUfGcZ092b0)” with 28 million views. For comparison, [this year’s WWDC keynote on YouTube](https://www.youtube.com/watch?v=hF8swzNR1-o) has 8.9 million views. 9 million views is a hell of a view count for the introduction of operating systems, but the iPhone remains king — not just for Apple, but the industry. It remains the Super Bowl of the annual tech calendar.

* For an even better comparison, [in the full version](https://archive.org/details/mwsf01_300) of that 2001 Macworld Expo keynote that I suggested you watch earlier in this column — the one where Steve Jobs introduced the Mac-as-digital-hub strategy — when Jobs takes the stage, he’s beaming with pride when he says there are “tens of thousands” of people watching the stream live. Both streaming and Apple have come a long way in 25 years.

---

1. I’ll just tuck in a footnote here that another necessary technical feature was high-speed USB-C, for recording video to external SSD drives. EU regulatory cheerleaders hang their hats on the belief that Apple switched iPhones from Lightning connectors to USB-C solely because of the EU charging port mandate. Some of them believe that absent EU intervention, iPhones today would still be on Lightning. That’s nonsense. These things are all true: the EU now mandates USB-C charging ports for phones (and most other devices); Apple opposed the EU USB-C mandate; the iPhone switched to USB-C in 2023 with the iPhone 15 generation; and the iPhone’s Lightning port was the last remaining proprietary phone connector that anyone cared about. But correlation is not causation. Apple opposed (and still opposes) the EU USB-C mandate not because they think USB-C is bad today, but because the mandate will stymie moving to something better (thinner / smaller / faster) in the future. (In 2011 the EU soft-mandated the terrible Micro-USB connector [in a “Memorandum of Understanding”](https://ec.europa.eu/commission/presscorner/detail/en/memo_11_75) that Apple of course ignored. USB-C is a good connector, but the lesson the European Commission took from their Micro-USB attempt was to hard-mandate their preferred universal connector this time — to switch from *should* to *must*.) Apple started moving iOS devices from Lightning to USB-C all the way back [in 2018 with the iPad Pros](https://daringfireball.net/2018/11/the_2018_ipad_pros). The EU USB-C mandate [didn’t come into effect until December 2024](https://commission.europa.eu/news-and-media/news/eu-common-charger-rules-power-all-your-devices-single-charger-2024-12-28_en). Apple had planned to move the iPhone to USB-C starting with the iPhone 15 generation years prior. If Apple had switched the iPhone to USB-C only for begrudging compliance with the EU mandate, they would have waited until 2024; Apple never complies early with regulations they disagree with. They also might have shipped USB-C iPhones exclusively within the EU. For years Apple shipped iPhones with two physical SIM card slots in China — region-specific hardware wouldn’t be new. They still today ship new iPhones with physical SIM card trays in most of the world but without them in the US models. But the best proof is that the iPhone 15 Pro models had camera features that required USB-C for data transfer performance.

   The theory that the EU dragged Apple kicking and screaming into switching the iPhone to USB-C is predicated on the notion that because Lightning was proprietary and USB-C is not, that Apple made a fortune selling Lightning accessories and didn’t want to give up that revenue stream. But Apple sells just as many [$20–30 USB-C cables](https://www.apple.com/shop/accessories/all/made-by-apple/cables) as they did $20–30 Lightning cables, and dirt-cheap Lightning cables from third-party companies were always plentiful (albeit not in Apple Stores). The iPhone switching to USB-C hasn’t affected Apple’s bottom line at all. This footnote, I’m sure, will put this matter to rest. [↩︎](#fnr1-2026-09-15)

2. Also interesting knowing that this was the first keynote produced [after Phil Schiller stepped down from running events](https://daringfireball.net/linked/2026/09/03/schiller-steps-down), yet Schiller is as big a Bond fan as anyone I know. The Bond references in the keynote might have been a nice nod to Schiller from his former team. [↩︎︎](#fnr2-2026-09-15)

3. Last year’s keynote announcement order: AirPods Pro 3, Apple Watch (Series 11 and Ultra 3), iPhone 17, iPhone Air, iPhone 17 Pro. This year’s order: iPhone 18 Pro, AirPods 5, Apple Watch, iPhone Duo. [↩︎︎](#fnr3-2026-09-15)

4. As I write this in mid-September, you can still purchase the iPhone 17 Pro and Pro Max at last year’s prices from carriers like [AT&T](https://www.att.com/buy/phones/apple-iphone-17-pro.html) and [Verizon](https://www.verizon.com/smartphones/apple-iphone-17-pro-max/), including the 1 TB 17 Pro for $1,500 and 2 TB 17 Pro Max for $2,000. It doesn’t make much sense to me to buy a 256 or 512 GB 17 Pro today just to save $100, unless you really love cosmic orange and feel disappointed by the 18 Pro colors. But if you really want 1 or 2 TB of storage, you’ll save $300 or $500 respectively buying a 17 Pro model instead of an 18 Pro. That’s real money. [↩︎︎](#fnr4-2026-09-15)

5. Have you noticed that more and more, people in window seats keep their windows closed, keeping the cabin dark, even for mid-day flights? I get it for early morning flights, but I don’t get it for mid-day and late afternoon flights. Sunlight is good. I’m an aisle-seat man myself, but when I get stuck with a window seat the best part is the view out the window. With the window closed, those seats aren’t much better than middle seats. [↩︎︎](#fnr5-2026-09-15)

6. Roger Moore played Bond in [seven films](https://www.007.com/the-films/), but never once ordered a martini nor uttered the “shaken not stirred” line. He did enjoy martinis in three of the movies, but in each case, the drink was [ordered or prepared for him](https://www.youtube.com/watch?v=zwvN0qvs5tA). This, despite Moore himself [having been a dry martini aficionado](https://daringfireball.net/linked/2017/05/23/moore-perfect). [↩︎︎](#fnr6-2026-09-15)

7. But the fact that the new CEO spent his career in hardware engineering tells you which side at Apple is the bigger 50 percent. [↩︎︎](#fnr7-2026-09-15)

8. The iPhone X (2436⁠ ⁠×⁠ ⁠1125 pixels) worked out to 2.1653 : 1. This week’s new iPhone 18 Pro (2622⁠ ⁠×⁠ ⁠1206 pixels) is 2.1741… : 1, and the 18 Pro Max (2868⁠ ⁠×⁠ ⁠1320) is 2.172 : 1. To two decimal places they’re all 2.17 : 1. [↩︎︎](#fnr8-2026-09-15)

9. Let’s keep going with the math pedantry. The Duo’s 5.4-inch outer display is 2034⁠ ⁠×⁠ ⁠1398 pixels, which [works out to about](https://www.wolframalpha.com/input?i=2,034+/+1,398) 1.455 : 1. The 7.8-inch inner display is 2670⁠ ⁠×⁠ ⁠1878 pixels, which works out to about 1.422 : 1. Calling them both “1.4 : 1” is close enough for government work. [↩︎︎](#fnr9-2026-09-15)

10. Back in 2021 during the COVID era, [iOS 14.5 added a then-much-needed feature](https://daringfireball.net/2021/02/unlock_with_apple_watch_with_face_mask) that allowed Apple Watch to unlock your iPhone. That feature [remains available](https://support.apple.com/guide/watch/unlock-your-iphone-apd2a4393dc1/watchos), and I guess that’s what Apple is promoting for use with iPhone Duo. But I had to check that this feature was still available in iOS because I haven’t used it since last wearing a face mask four or five years ago. [↩︎︎](#fnr10-2026-09-15)

11. Which raises an obvious question that I’ve never really thought hard about before: Why the hell can’t you unlock a Touch ID iPad with your Apple Watch, like you can with a Mac (or, now, an iPhone Duo)? [↩︎︎](#fnr11-2026-09-15)