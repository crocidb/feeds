...
description = "For many years now, part of the co-marketing agreements between Apple and the Big Three is Apple agreeing to require a postpaid account with a Big Three carrier for all “special” iPhone financing deals, including the old iPhone Upgrade Program and the new Apple Upgrade leasing."
date = "2026-08-03T17:19:34Z"
url = "https://daringfireball.net/2026/08/followup_big_three_carrier_requirement"
author = "John Gruber"
text = ""
lastupdated = "2026-08-10T22:24:07.356531314Z"
seen = true
+++

Following up from last week, [when I asked](https://daringfireball.net/linked/2026/07/30/apple-upgrade-vs-iphone-upgrade-program):

>
>
> When you lease an iPhone through Apple Upgrade, you need a cellular account on one of the big three U.S. carriers: AT&T, T-Mobile, or Verizon. That kind of stinks, and I’m not quite sure I understand why. You’re leasing the iPhone through Apple and Klarna, not the carrier, so I don’t know why Apple cares. If you know why, [shoot me a message](https://daringfireball.net/contact/) and explain it. Is it just a simplistic credit-risk evaluation, where prepaid plan-holders and MVNO users in general are viewed suspiciously?
>
>
...
One interesting exception is that Boost Mobile is included alongside the Big Three for Apple Card Monthly Installments (ACMI), a program that offers 0% APR on certain products if you pay for them using an Apple Card. [From the ACMI small print](https://support.apple.com/en-us/104950):
