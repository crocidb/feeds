...
description = "Every building in central Chicago was raised 10ft (30m) to add a sewage system underneath."
date = "2023-06-28T00:00:00Z"
url = "https://taylor.town/millennium-sewer"
author = "Taylor Troesh"
text = ""
lastupdated = "2026-04-20T13:20:40.542490070Z"
seen = true
+++

![cloaca maxima](https://taylor.town/Map_of_downtown_Rome_during_the_Roman_Empire_large-annotated.jpg)

In the mid-1800s, [every building in central Chicago was raised 10ft (30m)](https://en.wikipedia.org/wiki/Raising_of_Chicago). Yes, they literally used [jackscrews](https://en.wikipedia.org/wiki/Jack_(device)#House_jack) to lift entire city blocks up one-by-one.

Chicago had to [hotfix production](https://www.reddit.com/r/ProgrammerHumor/comments/blhec6/fixing_bugs_in_production/) because they built the city on the shoreline of Lake Michigan, where filth accumulated without natural drainage. They lifted the entire city *after* it was built so they could add sewers and prevent flooding.

For comparison, Rome's [Cloaca Maxima](https://en.wikipedia.org/wiki/Cloaca_Maxima) ("Greatest Sewer") is still in-use after 2,400 years.

So why didn't Chicago just build it right the first time?

* [Irreversible Decisions](#irreversible)
* [Unintended vs. Unforeseen](#unintended)
* [Always Scale Down](#scale-down)
* [Labor & Materials](#labor-materials)
* [Awful Architecture](#awful)
...
>
>
> \-- [Jeff Bezos](https://www.sec.gov/Archives/edgar/data/1018724/000119312516530910/d168744dex991.htm)
>
>
...
[Exxon executives knew that CO₂ emissions would harm Earth.](https://en.wikipedia.org/wiki/ExxonMobil_climate_change_denial)
...
Transparency thwarts [own goals](https://en.wikipedia.org/wiki/Own_goal). It's difficult to do stupid things when you do stupid things publicly.
...
>
>
> \-- Joe Armstrong from [Systems that run forever and self-heal and scale](https://www.youtube-nocookie.com/embed/cNICGEwmXLU?start=433)
>
>
...
*Exercise for the reader: Which is cheaper, a Nespresso machine or a [percolator](https://en.wikipedia.org/wiki/Coffee_percolator)?*
...
[Dvorak keyboards](https://en.wikipedia.org/wiki/Dvorak_keyboard_layout) reduce finger fatigue using the same materials as QWERTY keyboards.

[Juicero](https://en.wikipedia.org/wiki/Juicero) famously launched a high-tech product that was inferior to traditional juicers [in every comparable way](https://en.wikipedia.org/wiki/Juicero#Criticism):
