...
description = "I’ve been on the lookout for a scripting language which can be neatly embedded into Hare programs. Perhaps the obvious candidate is Lua – but I’m not particularly enthusiastic about it. When I was evaluating the landscape of tools which are “like Lua, but "
date = "2025-08-20T00:00:00Z"
url = "https://drewdevault.com/blog/Hare-and-Wren/"
...
In addition to exposing the basic Wren virtual machine to Hare, hare-wren has an optional submodule, wren::api, which implements a simple async runtime based on [hare-ev](https://sr.ht/~sircmpwn/hare-ev) and a modest “standard” library, much like [Wren CLI](https://wren.io/cli/). I felt that the Wren CLI libraries had a lot of room for improvement, so I made the call to implement a standard library which is only somewhat compatible with Wren CLI.
