...
description = "US politics has been pretty fascist lately. The state is filling up concentration camps, engaging in mass state violence against people on the basis of racialized traits, deporting them to random countries without any respect for habeas corpus, exerting state pressure on the free"
date = "2025-09-24T00:00:00Z"
url = "https://drewdevault.com/blog/Cloudflare-and-fascists/"
...
It’s in this disturbing political context that I saw an odd post from the Cloudflare blog pop up in my circles this week: [Supporting the future of the open web: Cloudflare is sponsoring Ladybird and Omarchy](https://blog.cloudflare.com/supporting-the-future-of-the-open-web/). Based on [Ladybird’s sponsorship terms](https://ladybird.org/#faq) we can assume that these projects received on the order of $100,000 USD from Cloudflare. I find this odd for a few reasons, in particular because one thing that I know these two projects have in common is that they are both run by fascists.
...
Ladybird makes some sense, given that it’s aligned in principle with Cloudflare’s stated objective to “support the open web”, though I remain bearish that new web browser engines are even [possible to make](https://drewdevault.com/2020/03/18/Reckless-limitless-scope.html).<sup class="footnote-ref"><a href="#fn-1" id="fn-1-ref-1">1</a></sup> Omarchy is a bizarre choice, though – do we really need another pre-customized Arch Linux distribution? And if we do, do we really need a big corporation like Cloudflare to bankroll it? Everyone on /r/unixporn manages to make Arch Linux look pretty for free.

Omarchy is a *very* weird project to fund, come to think of it. Making an Arch Linux spin technically requires *some* work, and work is work, I won’t deny it, but most of the work done here is from Arch Linux and Hyprland. Why not fund those, instead? Well, don’t fund Hyprland, since it’s also [run by](https://drewdevault.com/2023/09/17/Hyprland-toxicity.html) a [bunch of fascists](https://drewdevault.com/2024/04/09/2024-04-09-FDO-conduct-enforcement.html), but you get my point.

Anyway, Omarchy and Ladybird are both run by fascists. Omarchy makes this pretty obvious from the outset – on [the home page](https://omarchy.org/) the big YouTube poster image [prominently features](https://redacted.moe/f/ba0d7a6b.png) SuperGrok, which is a pathetically transparent dog-whistle to signal alliance with Elon Musk’s fascist politics. Omarchy is the pet project of David Heinemeier Hansson, aka DHH, who is well known as a rich [fascist](https://davidcel.is/articles/rails-needs-new-governance) [weirdo](https://tekin.co.uk/2025/09/the-ruby-community-has-a-dhh-problem).<sup class="footnote-ref"><a href="#fn-2" id="fn-2-ref-1">2</a></sup> One need only consult [his blog](https://world.hey.com/dhh) to browse his [weird, racist views on immigration](https://world.hey.com/dhh/as-i-remember-london-e7d38e64), [fat-shaming objections to diverse representation](https://world.hey.com/dhh/the-beauty-of-ideals-b3dccf72), [vaguely anti-feminist/homophobic/rapey rants on consent](https://world.hey.com/dhh/the-parental-dead-end-of-consent-morality-e4e8a8ee), and, recently, [tone-policing antifascists](https://world.hey.com/dhh/words-are-not-violence-c751f14f) who celebrate the death of notable fascist Charlie Kirk.
...
Kling has had a few things to say about Kirk on Twitter lately. [Here’s another one](https://nitter.net/awesomekling/status/1967178708852097278) – give you three guesses as to which “[group]” he objects to punching. You may also recall that Kling achieved some notoriety for his obnoxious response as the maintainer of SerenityOS when someone proposed gender-neutral language for the documentation:

[](https://github.com/SerenityOS/serenity/pull/6814)

[![](https://redacted.moe/f/d57df43b.png) Screenshot of the interaction on GitHub. Kling responds “This project is not an appropriate arena to advertise your personal politics.”](https://github.com/SerenityOS/serenity/pull/6814)

Replacing “he” with “they” in one sentence of the documentation is the kind of “ideologically motivated change” that Serenity’s [CONTRIBUTING.md](https://github.com/SerenityOS/serenity/blob/master/CONTRIBUTING.md#on-ideologically-motivated-changes) apparently aims to prevent, a classic case of the sexist “identities that are not men are inherently political” nonsense. Ladybird has a [similar, weirdly defensive policy](https://github.com/LadybirdBrowser/ladybird/blob/master/CONTRIBUTING.md#on-neutrality) on “neutrality”, and a milquetoast [code of conduct](https://github.com/LadybirdBrowser/ladybird/blob/master/CODE_OF_CONDUCT.md), which is based on the Ruby Community Conduct Guideline, which has been itself the subject of many controversies due to its inadequacy leading to real-world incidents of harassment and abuse.
...
– [@awesomekling](https://nitter.net/awesomekling/status/1874518295350837401) replying to @danheld<sup class="footnote-ref"><a href="#fn-3" id="fn-3-ref-1">3</a></sup>

And in a moment of poetic irony, a few days ago Kling [spoke in solidarity](https://nitter.net/awesomekling/status/1969350008538370216) with Hansson over his “persecution” for “banal, mainstream positions” on Twitter just a few days ago, in response to Hansson’s tweet signal-boosting another [notable reactionary tech fascist](https://www.youtube.com/watch?v=mhqeuO9RKKk), Bryan Lunduke.
