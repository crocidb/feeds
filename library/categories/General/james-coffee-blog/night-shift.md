+++
title = "Night shift"
description = "Writing my post on how I use my phone in grayscale yesterday got me thinking about other customisations I make to the computing devices I use. The first one that came to mind is that I keep my laptop, and by extension my external display when I am using it, in night shift mode at"
date = "2026-05-05T00:00:00Z"
url = "https://jamesg.blog/2026/05/05/night-shift"
...
![The Apple Night Shift window. This image is described in the previous paragraph.](https://editor.jamesg.blog/content/images/2026/05/nightshift.png)
...
In addition to using Apple’s night shift feature, I also have [Flux](https://justgetflux.com/) installed, an application that shifts the colour on your computer. I am not exactly sure how Flux interacts with the system-level settings, but I do know that my display gets warmer at night. I like the way I have things set up.
...
[how I use my phone in grayscale](https://jamesg.blog/2026/05/04/using-greyscale) [Flux](https://justgetflux.com/) [According to Apple, night shift mode](https://support.apple.com/en-gb/118583)