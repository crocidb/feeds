+++
title = "Artemis changelog #8"
description = "I have been working on a few new features for Artemis, the calm web reader I maintain. You can read a summary of what’s new below. Organise subscriptions with folders You can now create folders in Artemis. This feature is designed to help you organise websites you follow into sep"
date = "2026-03-06T00:00:00Z"
url = "https://jamesg.blog/2026/03/06/artemis-changelog-8"
author = "James' Coffee Blog"
text = ""
lastupdated = "2026-03-18T21:57:44.625228622Z"
seen = true
+++
...
![A form input field with the label "Folder" and the descriptive text "You can put this subscription in a folder so it shows up in a custom view in your reader."](https://editor.jamesg.blog/content/images/2026/03/folder-1.png)
...
![A form label with the text "Should YouTube Shorts by this author be hidden from your reader?" with a checkbox next to it.](https://editor.jamesg.blog/content/images/2026/03/ytshorts.png)

ALT

A form label with the text "Should YouTube Shorts by this author be hidden from your reader?" with a checkbox next to it.

*Thanks to* [*Ava*](https://blog.avas.space) *and* [*Suliman*](https://blog.sulimans.space/) *for providing the inspiration for these features!*

[\_Ava\_](https://blog.avas.space) [\_Suliman\_](https://blog.sulimans.space/)