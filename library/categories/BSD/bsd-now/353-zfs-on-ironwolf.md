+++
title = "353: ZFS on Ironwolf"
description = "Scheduling in NetBSD, ZFS vs. RAID on Ironwolf disks, OpenBSD on Microsoft Surface Go 2, FreeBSD for Linux sysadmins, FreeBSD on Lenovo T480, and more.NOTES   This episode of BSDNow is brought to you by TarsnapHeadlines[Scheduling i"
date = "2020-06-04T15:00:00Z"
url = "https://www.bsdnow.tv/353"
...
>  While there is no graphical installation, the installation process is straightforward and similar to installing a server-based Linux distro. Just make sure you choose the local\_unbound package when prompted if you want to cache DNS lookups locally, as FreeBSD doesn’t have a built-in local DNS resolver that does this.  
...
* [Benjamin - ZFS Question](<https://github.com/BSDNow/bsdnow.tv/blob/master/episodes/353/feedback/Benjamin - ZFS Question.md>)

* [Brad - swap\_pager\_getswapspace errors](<https://github.com/BSDNow/bsdnow.tv/blob/master/episodes/353/feedback/Brad - swap_pager_getswapspace errors.md>)

* [Brandon - gaming](<https://github.com/BSDNow/bsdnow.tv/blob/master/episodes/353/feedback/Brandon - gaming.md>)
...
* [Tarsnap](https://www.tarsnap.com/bsdnow) Promo Code: bsdnow