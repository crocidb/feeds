+++
title = "Running a Goaccess Server on NixOS"
description = "Goaccess is an open source real-time web log analyzer. We can use it to parse a server access log file, such as of Nginx, and see the analysis report in a terminal in real-time. However, Goaccess also comes with an HTTP server built i"
date = "2025-04-20T00:00:00Z"
url = "https://abhinavsarkar.net/notes/2025-goaccess-server-on-nixos/"
...
This post was originally published on [abhinavsarkar.net](https://abhinavsarkar.net/notes/2025-goaccess-server-on-nixos/?mtm_campaign=feed).

<details> <summary> So I wrote a NixOS service module for Goaccess server. </summary>
...
* [Fediverse](https://fantastic.earth/@abnv/114371114365696704)
* [Reddit](https://www.reddit.com/r/NixOS/comments/1k3pw5g/)
* [My website](https://abhinavsarkar.net/notes/2025-goaccess-server-on-nixos/?mtm_campaign=feed#comment-container)
