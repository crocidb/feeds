+++
title = "Using encapsulated development to code on my phone"
description = "I’m lucky enough to have a wife, two young children and a job as an AI Engineer at Notion. I’m also lucky enough to have a side project.Some weeks, I’ll get half an hour on my laptop to work on this side project. Most weeks, I won’t. Yet, I’ve averaged two commits to the project "
date = "2026-05-25T07:00:00Z"
url = "https://maryrosecook.com/blog/post/using-encapsulated-development-to-code-on-my-phone"
author = ""
text = ""
...
For a web app, this might mean having Chrome DevTools actually click through the UI to check it works. Or spinning up the API and checking that inputs produce the expected outputs. Or going full \~[StrongDM](https://simonwillison.net/2026/Feb/7/software-factory/)\~ and implementing the external services the product interacts with.
