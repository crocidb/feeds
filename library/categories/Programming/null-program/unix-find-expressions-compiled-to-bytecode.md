...
description = "In preparation for a future project, I was thinking about at the unix find utility. It operates a file system hierarchies, with basic operations selected and filtered using a specialized expression language"
...
**Update**: Or try [the **online demo**](https://nullprogram.com/scratch/findc/) via Wasm! This version includes a peephole optimizer I wrote after publishing this article.
...
Two `not` in a row cancel out, and so these instructions could be eliminated. Overall this compiler could benefit from a [peephole optimizer](https://en.wikipedia.org/wiki/Peephole_optimization), scanning over the program repeatedly, making small improvements until no more can be made:
