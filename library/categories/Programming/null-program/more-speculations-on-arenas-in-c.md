...
description = "Update October 2025: further enhancements.Patrice Roy’s new book, C++ Memory Management, has made me more conscious of object lifetimes. C++ is stricter than C about lifetimes, an"
date = "2025-09-30T11:46:16Z"
url = "https://nullprogram.com/blog/2025/09/30/"
author = "Christopher Wellons"
text = ""
lastupdated = "2025-10-22T08:59:04.635014831Z"
seen = true
---

*Update October 2025: [further enhancements](/blog/2025/10/16/)*.

Patrice Roy’s new book, [*C++ Memory Management*](https://www.packtpub.com/en-us/product/c-memory-management-9781805129806), has made me more conscious of object lifetimes. C++ is stricter than C about lifetimes, and common, textbook memory management that’s sound in C is less so in C++ — *more than I realized*. The book also presents a form of arena allocation so watered down as to enjoy none of the benefits. (Despite its precision otherwise, the second half is also littered with [integer overflows](https://github.com/PacktPublishing/C-Plus-Plus-Memory-Management/blob/9e4c4ea7/chapter12/Vector-better.cpp#L45) lacking [the appropriate checks](/blog/2024/05/24/), and near the end has some [pointer overflows](https://github.com/PacktPublishing/C-Plus-Plus-Memory-Management/blob/9e4c4ea7/chapter14/Vector_with_allocator_cpp23.cpp#L118-L119) invalidating the check.) However, I’m grateful for the new insights, and it’s made me revisit [my own C++ arena allocation](/blog/2024/04/14/). In this new light I see I got it subtly wrong myself!

Surprising to most C++ programmers, but not language lawyers, [idiomatic C memory allocation was ill-formed in C++ until recently](https://wg21.link/P0593#idiomatic-c-code-as-c):
