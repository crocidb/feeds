...
description = "I manage my legally obtained content using a media server. Over the years, both hardware and software on the server went through a bunch of transformations which I find interesting.In order to not look at ads on my Samsung TV, I view all of my content through NVIDIA Shield. It is"
