...
description = "I find that ai can help significantly with doing plumbing, but it has no problems with connecting the pipes wrong. I need to double and triple check the updated code - or fix the resulting errors when I don’t do that.[thih9 on Hacker News](https://news.ycombinator.com/it"
date = "2024-11-12T19:33:00Z"
url = "http://jonashietala.se/blog/2024/10/31/why_i_dont_rely_on_ai_for_programming_too_much/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.145320539Z"
seen = true
---
...
[I’m bad at double-checking code](#Im-bad-at-double-checking-code)
----------
...
I’m specifically talking about *verifying* code, not on figuring out what the code is trying to do or even the intent behind the code, which I think I’m relatively decent at.

### [Struggling to verify math problems](#Struggling-to-verify-math-problems) ###
...
### [It’s hard to read code without a mental model](#Its-hard-to-read-code-without-a-mental-model) ###
...
### [I struggle to properly review code](#I-struggle-to-properly-review-code) ###
...
[AI generated code requires careful verification](#AI-generated-code-requires-careful-verification)
----------
...
Relying on AI is like copy pasting code from [Stack Overflow](https://stackoverflow.com/): useful but you cannot trust it. While the code may look good on a surface level, it’s often subtly wrong in ways that even a [Stack Overflow](https://stackoverflow.com/) answer doesn’t quite manage to. Hallucinating a non existing library function or adding an extra argument are quite common.
...
[Programming less and reviewing more is a bad trade](#Programming-less-and-reviewing-more-is-a-bad-trade)
----------
...
### [You still need to build a mental model](#You-still-need-to-build-a-mental-model) ###
...
### [There’s no return of your investment](#Theres-no-return-of-your-investment) ###
...
Wait, what about context windows? Well, there’s no way to keep a context window spanning months or years. The learning I’m talking about is more akin to training or tuning an LLM.

Maybe your own AI developer that you’ll tune every time you interact with it will be available soon™.

[Some AI tools are very useful](#Some-AI-tools-are-very-useful)
----------

I need to clarify that while I’m skeptical towards the current AI hype I find some AI tools useful in various contexts.

For programming I’m a heavy user of [Kagi’s quick answer](https://help.kagi.com/kagi/ai/quick-answer.html) functionality that uses AI to summarize the search results and gives you references so you can drill down further if you need to. I use it many times a day to answer questions like:
...
![](https://imgs.xkcd.com/comics/extrapolating.png) [xkcd: 605](https://xkcd.com/605/); ever relevant as a response to the currently hyped technology.