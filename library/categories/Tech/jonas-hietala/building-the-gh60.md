...
description = "I’ve finally completed my first custom made keyboard. I’m still missing stabilizers and some smaller screws to hold it all together but I’ve been using it the last days and I thought I’d share.The hardwareSeveral years ago I joined the [geekhack forum](https://geekhack."
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2016/10/12/building_the_gh60/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.500816686Z"
seen = true
---
...
Several years ago I joined the [geekhack forum](https://geekhack.org/index.php) and I joined in a few group buys. I ordered some cool keycaps and I also entered the [GH60 Group Buy](https://geekhack.org/index.php?topic=41464.0) which sold plates, stabilizers, PCBs and switches so you can build a more minimalistic keyboard. Unfortunately the group buy crashed and burned and it’s long overdue with the creators vanishing and leaving the group buy with not enough money. I did get my two PCBs and my switches but I’m still waiting for my plates and stabilizers… Which may never arrive.

I did source a 60% plate from [massdrop](https://www.massdrop.com/buy/60-aluminum-plate) and I used [Cherry MX Green](https://deskthority.net/wiki/Cherry_MX_Green) switches which is a harder clicky cherry variant.

Pictures
==========

<img src="/images/gh60_pink/solder.jpg" width="400"> My beautiful solder job <img src="/images/gh60_pink/back.jpg" width="600"> In all it’s glory <img src="/images/gh60_pink/sideview.jpg" width="600"> You can see the plate mashed between the switches and the PCB <img src="/images/gh60_pink/switches.jpg" width="600"> A full view of the switches from the top <img src="/images/gh60_pink/keycaps.jpg" width="800"> The beautiful keycaps
...
I tried out both the [tmk\_keyboard](https://github.com/tmk/tmk_keyboard) and [qmk\_firmware](https://github.com/jackhumbert/qmk_firmware) for my keyboard. qmk is basically the same as tmk but with extended features (which I don’t think I’m currently using?).

The code is available on github: [https://github.com/treeman/qmk\_firmware](https://github.com/treeman/qmk_firmware)
