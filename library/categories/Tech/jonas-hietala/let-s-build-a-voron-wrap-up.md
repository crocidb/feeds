---
title = "Let's build a VORON: Wrap-up"
description = "It’s finally done™. I’ve built a VORON that prints reliably and I’ve modded it enough to be able to leave it alone for a while, so I think it’s time to wrap up this build series with a little retrospective.[Building the printer was really"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2024/03/05/lets_build_a_voron_wrap-up/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.243288265Z"
seen = true
---
...
![](/images/trident/finished_printing.gif)

[Building the printer was really fun and rewarding](#Building-the-printer-was-really-fun-and-rewarding)
----------
...
[There’s so much to learn](#Theres-so-much-to-learn)
----------
...
[Some modding is required](#Some-modding-is-required)
----------

Okay, you can use the printer as-is. But in my mind some modding is required to get the most out of it:

1. [HEPA filter](/blog/2023/12/15/lets_build_a_voron_filters/#hepa-exhaust-filter) seems like a must.
...
2. A [smart filament sensor](/blog/2024/02/27/lets_build_a_voron_more_mods/#Smart-filament-sensor) saves you so much grief.
...
1. [Removable top panel](/blog/2024/02/27/lets_build_a_voron_more_mods/#Removable-panels).
2. [Some sort of camera](/blog/2024/02/27/lets_build_a_voron_more_mods/#Angry-cam) (maybe not the Angry CAM).
3. [RockNRoll](/blog/2024/02/27/lets_build_a_voron_more_mods/#RockNRoll) (or [inverted electronics](https://mods.vorondesign.com/details/pXkXHVIUbqSWqQKJISczw), but maybe plan for that from the start).

(Modding is also one of the most fun parts, feel free to go nuts!)

[Issues with the kit](#Issues-with-the-kit)
----------

Overall, the printer and kit was good and I haven’t had many issues with it. I did however have two larger issues:

1. The [printer was loud](/blog/2024/02/28/lets_build_a_voron_noise/).
2. The [POM nuts wore out](/blog/2024/03/01/lets_build_a_voron_major_failure/).
...
3. Complete the [purge bucket mod](/blog/2024/02/27/lets_build_a_voron_more_mods/#Purge-bucket-CNC-Tap).
4. Try the [inverted electronics](https://mods.vorondesign.com/details/pXkXHVIUbqSWqQKJISczw) mod.
5. Replace Stealthburner with the [Xol toolhead](https://github.com/Armchair-Heavy-Industries/Xol-Toolhead/tree/main) for better PLA cooling.
6. Multimaterial with the [Enraged Rabbit Carrot Feeder](https://github.com/Enraged-Rabbit-Community/ERCF_v2).
