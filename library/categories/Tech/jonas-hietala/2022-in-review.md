...
description = "A bit late, but it’s time for my yearly review. It’s something I like doing for myself and it’s nice to see that despite a tough year I’ve done some good things.2022 Non-Geek Achievements We got our third child!  This time we got a girl to "
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2023/02/15/2022_in_review/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.347433907Z"
seen = true
---

A bit late, but it’s time for my [yearly review](/blog/tags/yearly_review/). It’s something I like doing for myself and it’s nice to see that despite a tough year I’ve done some good things.
...
* Wrote [4 blog posts](/archive).

2022 Geek Achievements
==========

* [Rewrote the blog in Rust](/blog/2022/08/29/rewriting_my_blog_in_rust_for_fun_and_profit/).

* Wrote more Rust (thanks to my job).

* Wrote some Typescript (again due to my job).

* Started home automation with [Home Assistant](https://www.home-assistant.io/).

  It started with us installing solar panels, and I wanted to get some pretty graphs from it to see how it performed.

  ![](/images/solar.png) Pretty graphs in Grafana. Even though it’s cold and snowy, we still produce some energy.

  But it all went downhill from there…

  ![](/images/zigbee.png)

  The core of my zigbee network connecting some lamps, plugs, switches and controls in our home. There are now 52 connected devices, and it will continue to grow.

  There are still *tons* of things I want to implement, fix and play around with. I think it’s best not to think of smart-home as some sort of money or time saver, but more as a hobby that might have some positive effects.

Books I remember
==========

* The [*Gentlemen Bastards Series*](https://www.goodreads.com/series/43531-gentleman-bastard).

  Disgustingly evil and I’ve got another book to eternally wait for (like the now 12 year wait for *Winds of Winter*).

* [*The Power of Habit*](https://charlesduhigg.com/the-power-of-habit/) and [*Atomic Habits*](https://jamesclear.com/atomic-habits).
...
* *[Spirit Island](https://boardgamegeek.com/boardgame/162886/spirit-island)*
  ...
  I’ve never played a boardgame solo before, as I always identified boardgames with social interactions. But there’s really no difference between playing a boardgame alone, versus playing a computer game alone. And I had an extremely good time playing Spirit Island.

* *[Great Western Trail](https://boardgamegeek.com/boardgame/341169/great-western-trail-second-edition)*

  If you put me on the spot to name my current #1 boardgame, I’d have to give it to Great Western Trail. Such an amazingly well designed game.
...
* *[Clinic Deluxe Edition](https://boardgamegeek.com/boardgame/272739/clinic-deluxe-edition)*
...
* *[Netrunner](https://boardgamegeek.com/boardgame/124742/android-netrunner)*
  ...
  Unfortunately it became a bit too much and I got burnt out from [the Mumbad Cycle meta](https://www.reddit.com/r/Netrunner/comments/a0pz32/mumbad_cycle_is_usually_considered_the_lowpoint/eajoe5t/), so I took a break to focus on other things, and then Fantasy Flight stopped developing the game. A sad ending to a great game.

  Or so I thought. The fan organization [Null Signal Games](https://nullsignal.games/) (previously Nisei) has continued to support the game and has continued to release new cards for Netrunner, keeping the game alive and well.
...
* *[Carcassonne](https://boardgamegeek.com/boardgame/822/carcassonne)* and *[Dragomino](https://boardgamegeek.com/boardgame/300010/dragomino)*
...
* Got depressed and burnt-out.
  ...
  I’ve been meaning to write a post about this, but I haven’t had the energy for it yet. I think it’s enough to say that this defined 2022 for me, and even though I was on sick leave for “only” two months, I still haven’t fully recovered my energy and productivity despite the first serious symptoms revealing themselves over a year ago.
...
* Establish [Deep Work](https://www.lifehack.org/849518/deep-work-rules) as my [keystone habit](https://jamesclear.com/keystone-habits).
...
* Finish the digital version of [my book](https://whycryptocurrencies.com/).
...
* Play games instead of doom scrolling on the phone or lazily watch TV.
  ...
  As I’m writing this I’ve had my [Steam Deck](https://www.steamdeck.com/en/) for around a month, and it’s absolutely amazing.