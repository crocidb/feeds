...
description = "A good writer isn’t born; a good writer is createdIt may sound dumb, but one of my reasons for writing a book was to improve my writing ability. Maybe I could’ve practiced on the blog instead, but putting things on paper gave it some added weight I don’t think I would’ve gotten"
date = "2024-07-17T19:35:07Z"
url = "http://jonashietala.se/blog/2023/11/25/writing_lessons_learned_after_writing_a_book/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.292234523Z"
seen = true
---
...
Here are some of my most important writing takeaways I’ve gotten from the process of writing a book. These aren’t original by any means, just things I’ve collected during the process. Many details are from the excellent book [On Writing Well: The Classic Guide to Writing Nonfiction](https://www.goodreads.com/book/show/53343.On_Writing_Well) that I can’t recommend highly enough.
...
* Are you [using the character types](https://practicaltypography.com/type-composition.html); commas, ellipses, hyphens, dashes and brackets?

Remove unnecessary words
----------

My biggest takeaway from [On Writing Well](https://www.goodreads.com/book/show/53343.On_Writing_Well) is that if you can remove a word or two from a sentence, it’s probably a good idea to do so.

1. Quite often we use extra words that don’t really add anything of value.
2. We often use extra words that don’t add anything of value.
3. We often use redundant words.
...
>
>
> Attributed to far too many people
>
>
...
[A Song of Ice and Fire](https://www.goodreads.com/series/43790-a-song-of-ice-and-fire) is my favorite book series, but I’m sure that if George R. R. Martin had been more focused on writing consistently—instead of waiting for inspiration—we wouldn’t be here still waiting for the next book a decade later, worried that he’ll die before he finishes the series.

And he’s not alone. [The Gentlemen Bastard](https://www.goodreads.com/series/43531-gentleman-bastard) series is just as good, but we’ve been waiting a decade for the next book there too. Although I haven’t read it yet, [The Kingkiller Chronicle](https://en.wikipedia.org/wiki/The_Kingkiller_Chronicle) is another example.
...
2. Make the writing consistent.
3. Find and fix errors, both large and small.
4. Reduce fluff.
5. Ensure that the core message is delivered as clearly and strongly as possible.
...
2. I wrote one chapter at a time (not necessarily in order).
3. I revised the planned chapters over time.
4. I rewrote *a lot*.
...
I may start with a simple list of things I want to say, but my goal is to turn that into headers and sub-headers. As an example, these are the headers from the post [Battling burnout](/blog/2023/03/14/battling_burnout/):
...
2. [Establishing a writing habit is crucial.](#consistency-is-the-most-important-thing)
3. [Rewriting is very important.](#rewrite-rewrite-rewrite)
4. [Clear up your thoughts to clear up your writing.](#clarity-of-thought-translates-into-clear-writing)
5. [Outlining the book and chapters helps you and the reader.](#have-a-plan-and-an-outline)
6. [Don’t strive for perfection.](#perfectionism-is-a-blessing-and-a-curse)
