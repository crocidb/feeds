...
description = "I recently came upon a horror story where a developer was forced to switch editor from Neovim to Cursor and I felt I had to write a little to cleanse myself of the disgust I felt.[Two different ways"
date = "2025-02-21T12:05:23Z"
url = "http://jonashietala.se/blog/2025/02/18/ill_give_up_neovim_when_you_pry_it_from_my_cold_dead_hands/index.html"
author = "Jonas Hietala"
text = ""
lastupdated = "2025-10-22T08:58:11.117240425Z"
seen = true
---

I recently came upon a horror story where a developer was [forced to switch editor from Neovim to Cursor](https://www.reddit.com/r/neovim/comments/1iqvv60/my_workplace_mandated_cursor/) and I felt I had to write a little to cleanse myself of the disgust I felt.

[Two different ways of approaching an editor](#Two-different-ways-of-approaching-an-editor)
----------
...
I don’t differentiate between text editors and IDEs as I don’t find the distinction very meaningful. They’re all just editors.

### [Freedom of choice is important](#Freedom-of-choice-is-important) ###
...
>
>
> Stephen Hendry, [The Mirror](https://www.mirror.co.uk/sport/other-sports/snooker/stephen-hendry-reveals-pre-match-13186275)
>
>

[Small improvements leads to large long-term gains](#Small-improvements-leads-to-large-long-term-gains)
----------
...
I firmly believe that even small improvements are worth it as they add up over time (also see [compound interest](https://www.investopedia.com/terms/c/compoundinterest.asp) and how it relates to financial investments).
...
* Customizing [your keyboard](/blog/2024/11/26/building_my_ultimate_keyboard/) and [keyboard layout](/series/t-34/)
...
[Neovim is versatile](#Neovim-is-versatile)
----------
...
* [Switched keyboard](/blog/2024/11/26/building_my_ultimate_keyboard/) and [keyboard layout](/series/t-34/) [multiple times](/blog/2024/11/26/the_current_cybershard_layout/).
* Been blogging and [wrote a book](/series/making-cryptobook/).
...
I did use Emacs at work for years because their proprietary language only had an Emacs integration and I didn’t have the time nor energy to create one for Neovim. While [Evil](https://github.com/emacs-evil/evil) made the experience survivable I realized then that I absolutely hate having my work setup be different from my setup at home.
...
[Neovim is easily extensible](#Neovim-is-easily-extensible)
----------
...
One way I use this customizability is to [help me when I’m blogging](/series/extending_neovim_for_my_blog/):
...
[Neovim won’t go anywhere](#Neovim-wont-go-anywhere)
----------
...
While Vim has—after an impressive 30 years of development—recently [entered maintenance mode](https://thenewstack.io/vim-after-bram-a-core-maintainer-on-how-theyve-kept-it-going/), activity in Neovim has steadily increased since the fork from Vim more than a decade ago. The amount of [high quality plugins](https://neovimcraft.com/), interest in [Google trends](<https://trends.google.com/trends/explore?date=today 5-y&q=neovim>), and [GitHub activity](https://star-history.com/#neovim/neovim&Date) have all been trending upwards. Neovim was also the most desired editor according to the [latest Stackoverflow developer survey](https://survey.stackoverflow.co/2024/technology#2-integrated-development-environment) and the overall buzz and excitement in the community is at an all-time high.
