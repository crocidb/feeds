+++
title = "Mildly Parboiled"
description = "Allergy season is finally fading (at least for me), but today was the first time I had to turn on the AC in the office, and it was great to realize that despite the recent Wi-Fi changes and almost four years of potential HomeKit foibles, my [ESP32 h"
date = "2026-05-28T13:56:00Z"
url = "https://taoofmac.com/space/blog/2026/05/28/1356?utm_content=atom"
author = "Rui Carmo"
text = ""
...
I, as usual, have been pragmatic about it and crafted my own agent to summarize meetings the way I want them, and to craft terse, minimalist works of corporate obeisance that avoid the walls of text I get by default and focus on the stuff I need to do instead of spouting corporate cheerleading (it has become [a surprisingly popular hack](/space/site/disclaimer)).
...
This has to change (somehow). In the meantime, part of that carve-out is also going to be about mental health–I’m phasing out Twitter/X again, as well as a bunch of other “social” distractions and hypefests like [HN](https://news.ycombinator.com?utm_source=taoofmac.com&utm_medium=web&utm_campaign=unsolicited_traffic&utm_content=external_link).