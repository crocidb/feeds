+++
title = "How Animals Navigate Darkness"
description = "Mouse brains perform a clever mechanism to count their steps and keep them on trackThe post How Animals Navigate Darkness appeared first on Nautilus."
date = "2025-12-18T02:00:00Z"
url = "https://nautil.us/how-animals-navigate-darkness-1255213/"
...
A team of scientists from the Max Planck Florida Institute for Neuroscience have recently uncovered new details about how these internal maps work: Rather than using a single internal clock, the brain uses two interacting sets of excitatory and inhibitory neurons in the hippocampus. The researchers published their [findings](https://www.nature.com/articles/s41467-025-67038-3) in *Nature Communications*.

ADVERTISEMENT

 Nautilus Members enjoy an ad-free experience. [ Log in ](https://nautil.us/concierge-login) or [ Join now ](/join).

Scientists have long known that the hippocampus helps animals navigate, and that some neurons fire up at specific places they visit. “However, in environments full of sights, sounds, and smells, it is difficult to tell whether these neurons are responding to those sensory cues or to the animal’s position itself,” explained Yingxue Wang, a neuroscientist at the Max Planck Florida Institute of Neuroscience and a paper co-author, in a [statement](https://mpfi.org/a-built-in-odometer-new-study-reveals-how-the-brain-measures-distance/).

**Read more: “**[**The Woman Who Got Lost at Home**](https://nautil.us/the-woman-who-got-lost-at-home-235768/)**”**
...
If similar patterns are found in people, they might help explain why people with Alzheimer’s disease and other types of dementia often become disoriented even in familiar places—and could point toward new therapeutic targets for restoring that lost sense of where we are. ![](https://assets.nautil.us/sites/3/nautilus/nautilus-favicon-14.png?fm=png)
