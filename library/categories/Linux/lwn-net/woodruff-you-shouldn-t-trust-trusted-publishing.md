...
description = 'William Woodruff, better known online as "yossarian", has published a blog post to make the case that users should not place their trust in [trusted publishing](https://docs.pypi.org/trusted-publishers'
date = "2026-07-07T14:27:57Z"
